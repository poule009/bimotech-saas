...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Mon espace <?php $__env->endSlot(); ?>
...
<div style="padding:24px 32px 48px">
    ...
    <div style="display:flex;align-items:flex-start;justify-content:space-between;margin-bottom:20px">
        ...
        <a href="<?php echo e(route('locataire.paiements')); ?>"
    ...
    <?php if($prochainePeriode): ?>
    <div class="next-loyer">
        <div class="nl-left">
            <div class="nl-label">Prochain loyer à régler</div>
            <div class="nl-periode"><?php echo e($prochainePeriode->translatedFormat('F Y')); ?></div>
            <?php if($dernierPaiement): ?>
                <div class="nl-hint">Dernier paiement : <?php echo e(\Carbon\Carbon::parse($dernierPaiement->periode)->translatedFormat('F Y')); ?></div>
            <?php else: ?>
                <div class="nl-hint">Premier paiement du bail</div>
            <?php endif; ?>
        </div>
        <div style="text-align:right">
            <div class="nl-amount"><?php echo e(number_format($contrat->loyer_contractuel, 0, ',', ' ')); ?></div>
    ...
    <div class="dash-grid">
        ...
        <div>
            ...
            <div class="bien-hero">
                ...
                <div class="hero-ref"><?php echo e($bien->reference); ?></div>
                <div class="hero-type">
                ...
                <div class="hero-stats">
                    <div class="hero-stat">
                        ...
                        <div class="hs-val gold"><?php echo e(number_format($contrat->loyer_contractuel, 0, ',', ' ')); ?><span style="font-size:11px;color:rgba(255,255,255,.3);margin-left:2px">F</span></div>
                    </div>
                    <div class="hero-stat">
                        <div class="hs-lbl">Début du bail</div>
                        <div class="hs-val"><?php echo e($debut->format('d/m/Y')); ?></div>
                    </div>
                    <div class="hero-stat">
                        <div class="hs-lbl">Caution versée</div>
                        <div class="hs-val green"><?php echo e(number_format($contrat->caution, 0, ',', ' ')); ?><span style="font-size:11px;color:rgba(74,222,128,.5);margin-left:2px">F</span></div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-hd">
                    ...
                    <span style="font-family:monospace;font-size:11px;color:#9ca3af"><?php echo e($contrat->reference_bail ?? '—'); ?></span>
                </div>
                <div class="card-body">
                    <div class="info-grid">
                        <div class="info-item">
                            <div class="il">Type de bail</div>
                            <div class="iv"><?php echo e(\App\Models\Contrat::TYPES_BAIL[$contrat->type_bail] ?? ucfirst($contrat->type_bail)); ?></div>
                        </div>
                        <div class="info-item">
                        ...
                        <div class="info-item">
                            ...
                            <div class="iv"><?php echo e($debut->format('d/m/Y')); ?></div>
                            <div class="iv-sub"><?php echo e($debut->diffForHumans()); ?></div>
                        </div>
                        <div class="info-item">
                            <div class="il">Date de fin</div>
                            <?php if($fin): ?>
                                <div class="iv <?php echo e($joursRestants !== null && $joursRestants <= 60 ? 'iv--warn':''); ?>">
                                    <?php echo e($fin->format('d/m/Y')); ?>

                                </div>
                                <?php if($joursRestants !== null && $joursRestants > 0): ?>
                                    <div class="iv-sub"><?php echo e($joursRestants); ?> jours restants</div>
                                <?php elseif($joursRestants !== null && $joursRestants <= 0): ?>
                        ...
                        <?php if($contrat->charges_mensuelles): ?>
                        <div class="info-item">
                            <div class="il">Charges mensuelles</div>
                            <div class="iv"><?php echo e(number_format($contrat->charges_mensuelles, 0, ',', ' ')); ?> F</div>
                        </div>
                        <?php endif; ?>

                        <?php if($contrat->tom_amount): ?>
                        <div class="info-item">
                            <div class="il">TOM</div>
                            <div class="iv"><?php echo e(number_format($contrat->tom_amount, 0, ',', ' ')); ?> F</div>
                        </div>
                        <?php endif; ?>
                    </div>

                    
                    <?php if($fin && $dureeProgress !== null): ?>
                    <div style="margin-top:16px;padding-top:14px;border-top:1px solid #f3f4f6">
                        <div style="display:flex;justify-content:space-between;margin-bottom:6px">
                            ...
                            <span style="font-size:11px;font-weight:600;color:#8a6e2f"><?php echo e($dureeProgress); ?>%</span>
                        </div>
                        <div class="duree-bar">
                            <div class="duree-fill" style="width:<?php echo e($dureeProgress); ?>%"></div>
                        </div>
                        <div style="display:flex;justify-content:space-between;margin-top:5px">
                            <span style="font-size:10px;color:#9ca3af"><?php echo e($debut->format('d/m/Y')); ?></span>
                            <span style="font-size:10px;color:#9ca3af"><?php echo e($fin->format('d/m/Y')); ?></span>
                        </div>
                    </div>
                    <?php endif; ?>
                    ...
                    <div style="margin-top:16px;padding:12px 14px;background:#f9fafb;border-radius:9px;border-left:3px solid #e5e7eb">
                        ...
                        <div style="font-size:13px;font-weight:500;color:#0d1117"><?php echo e($contrat->garant_nom); ?></div>
                        <?php if($contrat->garant_telephone): ?>
                            <div style="font-size:11px;color:#6b7280;margin-top:2px"><?php echo e($contrat->garant_telephone); ?></div>
                        <?php endif; ?>
                    </div>
                    <?php endif; ?>
                </div>
            ...
            <div class="card">
                <div class="card-hd">
                    ...
                    <a href="<?php echo e(route('locataire.paiements')); ?>" class="card-action">Voir tout →</a>
                </div>
                ...
                <div style="overflow-x:auto">
                    <table class="dt">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $paiements->take(6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td style="text-align:center">
                                    <a href="<?php echo e(route('locataire.paiements.pdf', $p)); ?>" target="_blank"
        ...
        <div class="sidebar-sticky">
            ...
            <div class="kpi-mini gold">
                ...
                <div class="kpi-val gold"><?php echo e(number_format($stats['total_paye'], 0, ',', ' ')); ?><span class="kpi-u">F</span></div>
                <div class="kpi-s">Depuis le début du bail</div>
            </div>

            <div class="kpi-mini green">
                <div class="kpi-lbl">Paiements effectués</div>
                <div class="kpi-val green"><?php echo e($stats['nb_paiements']); ?></div>
                <div class="kpi-s">Quittances disponibles</div>
            </div>

            <?php if($fin && $joursRestants !== null && $joursRestants > 0): ?>
            <div class="kpi-mini blue">
                <div class="kpi-lbl">Jours restants</div>
                <div class="kpi-val" style="color:#1d4ed8"><?php echo e($joursRestants); ?></div>
                <div class="kpi-s">Fin le <?php echo e($fin->format('d/m/Y')); ?></div>
            </div>
            <?php endif; ?>
                ...
                <div class="card-body" style="padding:14px 18px">
                    <div style="display:flex;align-items:center;gap:10px;margin-bottom:14px">
                        <div style="width:38px;height:38px;border-radius:10px;background:#f5e9c9;display:flex;align-items:center;justify-content:center;font-family:'Syne',sans-serif;font-size:14px;font-weight:800;color:#8a6e2f;flex-shrink:0">
                            <?php echo e(strtoupper(substr($proprietaire->name, 0, 2))); ?>

                        </div>
                        <div>
                            <div style="font-size:13px;font-weight:600;color:#0d1117"><?php echo e($proprietaire->name); ?></div>
                            <?php if($proprietaire->telephone): ?>
                            <a href="tel:<?php echo e($proprietaire->telephone); ?>" style="font-size:11px;color:#6b7280;text-decoration:none;display:flex;align-items:center;gap:3px;margin-top:2px">
                                ...
                                <?php echo e($proprietaire->telephone); ?>
            ...
            <div class="card">
                ...
                <div class="card-body" style="padding:14px 18px">
                    <div class="agence-card">
                        <div class="ag-name"><?php echo e($agency->name); ?></div>
                        ...
                        <div class="ag-row">
                            ...
                            <div class="ag-val"><a href="tel:<?php echo e($agency->telephone); ?>"><?php echo e($agency->telephone); ?></a></div>
                        </div>
                        <?php endif; ?>
                        <?php if($agency->email): ?>
                        <div class="ag-row">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
                            <div class="ag-val"><a href="mailto:<?php echo e($agency->email); ?>"><?php echo e($agency->email); ?></a></div>
                        </div>
                        <?php endif; ?>
                        <?php if($agency->adresse): ?>
                        <div class="ag-row">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg>
                            <div class="ag-val"><?php echo e($agency->adresse); ?></div>
                        </div>
                        <?php endif; ?>
                    </div>
