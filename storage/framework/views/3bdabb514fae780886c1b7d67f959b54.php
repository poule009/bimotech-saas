...
<a href="<?php echo e(url('/')); ?>" class="logo" aria-label="BimoTech Immo — Retour à l'accueil">Bimo<span>Tech</span></a>
...
<div class="content">
    ...
    <div class="actions">
        <a href="<?php echo e(url('/')); ?>" class="btn-gold">← Retour à l'accueil</a>
        <a href="<?php echo e(route('contact')); ?>" class="btn-outline">Nous contacter</a>
    </div>

    <nav class="quick-links" aria-label="Liens rapides">
        <a href="<?php echo e(route('faq')); ?>"     class="quick-link">FAQ</a>
        <a href="<?php echo e(route('demo')); ?>"    class="quick-link">Demander une démo</a>
        <a href="<?php echo e(route('login')); ?>"   class="quick-link">Connexion</a>
        <a href="<?php echo e(route('register')); ?>" class="quick-link">Créer un compte</a>
    </nav>
</div>

</body>
</html><?php /**PATH C:\Users\ph\bimotech-immo\resources\views/errors/404.blade.php ENDPATH**/ ?>