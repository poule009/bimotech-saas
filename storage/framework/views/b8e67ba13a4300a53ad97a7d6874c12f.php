...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <div style="display:flex;gap:6px;flex-wrap:wrap">
                                <?php $__currentLoopData = ['#c9a84c','#3b82f6','#22c55e','#ef4444','#8b5cf6','#0d1117','#06b6d4','#f59e0b','#1a3c5e','#ec4899']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="preview-card">
                        ...
                        <div class="mini-sidebar">
                            <div class="mini-sidebar-top">
                                <div class="mini-logo-box" id="preview-logo-box"
                                     style="background:<?php echo e($agency->couleur_primaire ?? '#c9a84c'); ?>">
                                    <?php if($agency->logo_path): ?>
                            ...
                            <div class="mini-nav">
                                ...
                                <div class="mini-nav-item">
                                    ...
                                    <div class="mini-nav-line <?php echo e($i % 2 ? 'short':''); ?>"></div>
                                </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        </div>
                    ...
                    <div class="info-grid">
                        <div class="info-row">
                            ...
                            <span class="info-val" id="info-name"><?php echo e($agency->name); ?></span>
                        </div>
                        <div class="info-row">
                            <span class="info-lbl">Email</span>
                            <span class="info-val" id="info-email"><?php echo e($agency->email ?? '—'); ?></span>
                        </div>
                        <div class="info-row">
                            <span class="info-lbl">Téléphone</span>
                            <span class="info-val <?php echo e(!$agency->telephone ? 'missing':''); ?>" id="info-tel">
                        ...
                        <div class="info-row">
                            ...
                            <span class="info-val <?php echo e(!$agency->ninea ? 'missing':''); ?>" id="info-ninea">
                        ...
                        <div class="info-row">
                            ...
                            <div style="display:flex;align-items:center;gap:6px;justify-content:flex-end">
                                <div id="info-color-dot" style="width:11px;height:11px;border-radius:3px;background:<?php echo e($agency->couleur_primaire ?? '#c9a84c'); ?>"></div>
                                <span class="info-val" id="info-color"><?php echo e($agency->couleur_primaire ?? '#c9a84c'); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card" style="margin-top:16px">
                    ...
                    <div class="card-body">
                        ...
                        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:12px">
                            <span style="font-size:12px;font-weight:600;color:#c9d1d9"><?php echo e($nbDone); ?>/<?php echo e(count($checks)); ?> complété<?php echo e($nbDone > 1 ? 's':''); ?></span>
                            <span style="font-size:11px;color:<?php echo e($pct === 100 ? '#4ade80':'#fbbf24'); ?>;font-weight:700"><?php echo e($pct); ?>%</span>
                        </div>
                        
                        <div style="height:4px;background:rgba(255,255,255,.06);border-radius:99px;margin-bottom:14px;overflow:hidden">
                            <div style="height:100%;width:<?php echo e($pct); ?>%;background:<?php echo e($pct === 100 ? '#4ade80':'#c9a84c'); ?>;border-radius:99px;transition:width .3s"></div>
                        </div>
                        <div class="checklist">
...
<?php if($agency->logo_path): ?>
<form id="form-delete-logo" method="POST" action="<?php echo e(route('admin.agency.logo.delete')); ?>" style="display:none">
    <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\ph\bimotech-immo\resources\views/admin/agency-settings.blade.php ENDPATH**/ ?>