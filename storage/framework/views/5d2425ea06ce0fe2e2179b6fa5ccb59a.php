...
<head>
    ...
    <title>Abonnement — <?php echo e($agency->name); ?></title>
...
<body class="bg-gray-50 min-h-screen">
    ...
    <header class="bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between">
        <div>
            <h1 class="text-xl font-bold text-gray-900"><?php echo e($agency->name); ?></h1>
    ...
    <main class="max-w-5xl mx-auto px-4 py-10">
        ...
        <?php if(session('warning')): ?>
            <div class="mb-8 bg-amber-50 border border-amber-200 text-amber-800 rounded-xl px-6 py-4 flex items-start gap-3">
                ...
                <div>
                    ...
                    <p class="text-sm mt-0.5"><?php echo e(session('warning')); ?></p>
                </div>
            </div>
        <?php endif; ?>
                    ...
                    <?php if($subscription->estEnEssai()): ?>
                        <div>
                            ...
                            <p class="font-semibold text-gray-800 mt-1">
                                <?php echo e($subscription->date_fin_essai->format('d/m/Y')); ?>

                                <span class="text-sm font-normal text-amber-600">
                                    (<?php echo e($subscription->joursRestantsEssai()); ?> jours restants)
                                </span>
                            </p>
                        </div>
                    <?php elseif($subscription->estActif()): ?>
                        <div>
                            ...
                            <p class="font-semibold text-gray-800 mt-1">
                                <?php echo e(\App\Models\Subscription::LABELS[$subscription->plan] ?? $subscription->plan); ?>
                        ...
                        <div>
                            ...
                            <p class="font-semibold text-gray-800 mt-1">
                                <?php echo e($subscription->date_fin_abonnement->format('d/m/Y')); ?>

                                <span class="text-sm font-normal text-gray-500">
                                    (<?php echo e($subscription->joursRestantsAbonnement()); ?> jours restants)
                                </span>
                            </p>
                        </div>
                    <?php endif; ?>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-10">
            ...
            <?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $planKey => $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="bg-white rounded-xl border-2 <?php echo e($plan['populaire'] ? 'border-blue-400' : 'border-gray-200'); ?> shadow-sm p-6 flex flex-col relative">

                    <?php if($plan['populaire']): ?>
                    ...
                    <p class="text-3xl font-bold text-gray-900">
                        <?php echo e($plan['prix']); ?>

                        <span class="text-base font-normal text-gray-500">FCFA</span>
                    </p>
                    <p class="text-sm <?php echo e($plan['eco'] ? 'text-green-600 font-medium' : 'text-gray-400'); ?> mt-1">
                        <?php echo e($plan['eco'] ? 'Économie ' . $plan['eco'] : $plan['duree']); ?>
                    ...
                    <ul class="mt-5 space-y-2 text-sm text-gray-600 flex-1">
                        ...
                        <li>✅ <?php echo e($plan['support']); ?></li>
                    </ul>

                    <form
                        method="POST"
                        action="<?php echo e(route('subscription.initier')); ?>"
                        class="mt-6"
                        onsubmit="return confirm('Confirmer l\'abonnement <?php echo e($plan['label']); ?> à <?php echo e($plan['prix']); ?> FCFA ?')"
                    >
                        <?php echo csrf_field(); ?>
                            ...
                            <?php $__currentLoopData = $historique; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $paiement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="hover:bg-gray-50 transition">
                                    <td class="px-6 py-4 text-gray-600">
                                        <?php echo e($paiement->created_at->format('d/m/Y à H:i')); ?>

                                    </td>
                                    <td class="px-6 py-4 text-center">
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                            <?php echo e(\App\Models\Subscription::LABELS[$paiement->plan] ?? $paiement->plan); ?>

                                        </span>
                                    </td>
                                    <td class="px-6 py-4 text-center text-gray-600">
                                        <?php echo e(\App\Models\SubscriptionPayment::METHODE_LABELS[$paiement->methode] ?? $paiement->methode); ?>

                                    </td>
                                    <td class="px-6 py-4 text-center text-gray-500 text-xs">
                                        <?php if($paiement->periode_debut && $paiement->periode_fin): ?>
                                            <?php echo e($paiement->periode_debut->format('d/m/Y')); ?>

                                            →
                                            <?php echo e($paiement->periode_fin->format('d/m/Y')); ?>
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        ...
                                        ?>
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($statutColors[$paiement->statut] ?? 'bg-gray-100 text-gray-800'); ?>">
...
</html><?php /**PATH C:\Users\ph\bimotech-immo\resources\views/subscription/index.blade.php ENDPATH**/ ?>