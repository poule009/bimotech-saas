...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Bilan fiscal — <?php echo e($proprietaire->name); ?> <?php $__env->endSlot(); ?>
...
<div class="page">
    ...
    <div style="display:flex;align-items:center;gap:8px;font-size:12px;color:#6b7280;margin-bottom:16px">
        <a href="<?php echo e(route('admin.bilans-fiscaux.index')); ?>" style="color:#6b7280;text-decoration:none">Bilans fiscaux</a>
        <svg style="width:12px;height:12px" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="9 18 15 12 9 6"/></svg>
        <span style="color:#0d1117;font-weight:500"><?php echo e($proprietaire->name); ?> — <?php echo e($annee); ?></span>
    </div>
    ...
    <div style="display:flex;align-items:flex-start;justify-content:space-between;margin-bottom:22px">
        <div>
            <h1 style="font-family:'Syne',sans-serif;font-size:22px;font-weight:700;color:#0d1117;letter-spacing:-.4px">
                Bilan fiscal <?php echo e($annee); ?> — <?php echo e($proprietaire->name); ?>

            </h1>
            <p style="font-size:13px;color:#6b7280;margin-top:3px">
                Calculé le <?php echo e($bilan->calcule_le->format('d/m/Y à H:i')); ?> ·
                <?php echo e($bilan->nb_paiements); ?> paiement(s) · <?php echo e($bilan->nb_biens_geres); ?> bien(s)
            </p>
        </div>
        <div style="display:flex;align-items:center;gap:10px">
            
            <form method="POST" action="<?php echo e(route('admin.bilans-fiscaux.calculate', $proprietaire)); ?>">
                <?php echo csrf_field(); ?>
            ...
            <a href="<?php echo e(route('admin.bilans-fiscaux.pdf', [$proprietaire, 'annee' => $annee])); ?>"
               target="_blank"
    ...
    <div class="page-grid">
        <div>
            ...
            <div class="kpi-grid">
                <div class="kpi gold">
                    ...
                    <div class="kpi-val"><?php echo e(number_format($bilan->revenus_bruts_loyers, 0, ',', ' ')); ?><span class="kpi-u">F</span></div>
                    <div class="kpi-sub">Loyers HT annuels</div>
                </div>
                <div class="kpi green">
                    <div class="kpi-lbl">Base imposable</div>
                    <div class="kpi-val"><?php echo e(number_format($bilan->base_imposable, 0, ',', ' ')); ?><span class="kpi-u">F</span></div>
                    <div class="kpi-sub">Après abattement 30%</div>
                </div>
                <div class="kpi red">
                    <div class="kpi-lbl">IRPP estimé</div>
                    <div class="kpi-val"><?php echo e(number_format($bilan->irpp_estime, 0, ',', ' ')); ?><span class="kpi-u">F</span></div>
                    <div class="kpi-sub">Art. 65 CGI SN</div>
                </div>
                <div class="kpi blue">
                    <div class="kpi-lbl">Net reversé</div>
                    <div class="kpi-val"><?php echo e(number_format($bilan->net_proprietaire_total, 0, ',', ' ')); ?><span class="kpi-u">F</span></div>
                ...
                <div class="card-body">
                    <div class="calc-bloc">
                        ...
                        <div class="calc-row">
                            ...
                            <div class="calc-val"><?php echo e(number_format($bilan->revenus_bruts_loyers, 0, ',', ' ')); ?> F</div>
                        </div>
                        <?php if($bilan->revenus_bruts_charges > 0): ?>
                        <div class="calc-row sub">
                            <div class="calc-lbl">+ Charges refacturées</div>
                            <div class="calc-val"><?php echo e(number_format($bilan->revenus_bruts_charges, 0, ',', ' ')); ?> F</div>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="calc-row" style="margin-top:6px">
                            ...
                            <div class="calc-val" style="color:#16a34a">− <?php echo e(number_format($bilan->abattement_forfaitaire_30, 0, ',', ' ')); ?> F</div>
                        </div>

                        
                        <div class="calc-row total">
                            <div class="calc-lbl">= Base imposable (70%)</div>
                            <div class="calc-val"><?php echo e(number_format($bilan->base_imposable, 0, ',', ' ')); ?> F</div>
                        </div>
                        ...
                        <table class="bareme-table" style="margin-bottom:12px">
                            ...
                            <?php $__currentLoopData = $tranches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                                $active = $base > $t['min'];
                            ...
                            ?>
                            <tr class="<?php echo e($active ? 'active' : 'inactive'); ?>">
                                <td><?php echo e($t['label']); ?></td>
                                <td><?php echo e($t['taux']); ?>%</td>
                                <td><?php echo e($active && $impot > 0 ? number_format($impot, 0, ',', ' ').' F' : '—'); ?></td>
                                <td>
                                    <div class="bareme-bar">
                                        <div class="bareme-bar-fill" style="width:<?php echo e($pct); ?>%;background:<?php echo e($active ? '#16a34a' : '#e5e7eb'); ?>"></div>
                                    </div>
                                </td>
                            </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="calc-row warning">
                            ...
                            <div class="calc-val"><?php echo e(number_format($bilan->irpp_estime, 0, ',', ' ')); ?> F</div>
                        </div>
                        ...
                        <div class="calc-row" style="margin-top:12px">
                            ...
                            <div class="calc-val" style="color:#d97706"><?php echo e(number_format($bilan->cfpb_estimee, 0, ',', ' ')); ?> F</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <?php if($bilan->tva_loyer_collectee > 0 || $bilan->brs_retenu_total > 0): ?>
            <div class="card">
                <div class="card-hd">
                    <div class="card-title">
                ...
                <div class="card-body">
                    <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px">
                        <?php if($bilan->tva_loyer_collectee > 0): ?>
                        <div style="background:#fff7ed;border:1px solid #fed7aa;border-radius:10px;padding:14px">
                            ...
                            <div style="font-family:'Syne',sans-serif;font-size:22px;font-weight:800;color:#d97706">
                                <?php echo e(number_format($bilan->tva_loyer_collectee, 0, ',', ' ')); ?> F
                            </div>
                        ...
                        <?php endif; ?>
                        <?php if($bilan->brs_retenu_total > 0): ?>
                        <div style="background:#fff1f2;border:1px solid #fecaca;border-radius:10px;padding:14px">
                            ...
                            <div style="font-family:'Syne',sans-serif;font-size:22px;font-weight:800;color:#dc2626">
                                <?php echo e(number_format($bilan->brs_retenu_total, 0, ',', ' ')); ?> F
                            </div>
            ...
            <div class="card">
                <div class="card-hd">
                    <div class="card-title">
                        ...
                        Commissions agence <?php echo e($annee); ?>
                ...
                <div class="card-body">
                    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:12px">
                        <div style="text-align:center;padding:14px;background:#fdf8ef;border-radius:10px;border:1px solid #f5e9c9">
                            ...
                            <div style="font-family:'Syne',sans-serif;font-size:18px;font-weight:700;color:#8a6e2f"><?php echo e(number_format($bilan->commissions_agence_ht, 0, ',', ' ')); ?> F</div>
                        </div>
                        <div style="text-align:center;padding:14px;background:#f9fafb;border-radius:10px;border:1px solid #e5e7eb">
                            ...
                            <div style="font-family:'Syne',sans-serif;font-size:18px;font-weight:700;color:#6b7280"><?php echo e(number_format($bilan->tva_commissions, 0, ',', ' ')); ?> F</div>
                        </div>
                        <div style="text-align:center;padding:14px;background:#f0fdf4;border-radius:10px;border:1px solid #bbf7d0">
                            ...
                            <div style="font-family:'Syne',sans-serif;font-size:18px;font-weight:700;color:#16a34a"><?php echo e(number_format($bilan->net_proprietaire_total, 0, ',', ' ')); ?> F</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-hd">
                    <div class="card-title">
                        ...
                        Paiements <?php echo e($annee); ?> (<?php echo e($paiements->count()); ?>)
                    </div>
                </div>
                <div style="overflow-x:auto">
                    <table class="dt">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?php echo e(\Carbon\Carbon::parse($p->periode)->translatedFormat('M Y')); ?></td>
                                <td>
                                    <div style="font-weight:600;color:#0d1117"><?php echo e($p->bien_reference ?? '—'); ?></div>
                                    <div style="font-size:11px;color:#9ca3af"><?php echo e(ucfirst($p->type_bail ?? '—')); ?></div>
                                </td>
                                <td style="font-size:12px;color:#6b7280"><?php echo e($p->contrat?->locataire?->name ?? '—'); ?></td>
                                <td>
                                    <?php if(($p->tva_loyer ?? 0) > 0): ?>
                                        <span class="badge badge-orange">TVA 18%</span>
                                    <?php else: ?>
                                        <span class="badge" style="background:#f3f4f6;color:#6b7280">Exonéré</span>
                                    <?php endif; ?>
                                </td>
                                <td class="r"><?php echo e(number_format($p->loyer_ht ?? $p->loyer_nu ?? 0, 0, ',', ' ')); ?> F</td>
                                <td class="r" style="<?php echo e(($p->tva_loyer ?? 0) > 0 ? 'color:#d97706' : 'color:#9ca3af'); ?>">
                                    <?php echo e(($p->tva_loyer ?? 0) > 0 ? number_format($p->tva_loyer, 0, ',', ' ').' F' : '—'); ?>

                                </td>
                                <td class="r" style="<?php echo e(($p->brs_amount ?? 0) > 0 ? 'color:#dc2626' : 'color:#9ca3af'); ?>">
                                    <?php echo e(($p->brs_amount ?? 0) > 0 ? number_format($p->brs_amount, 0, ',', ' ').' F' : '—'); ?>

                                </td>
                                <td class="r" style="color:#16a34a"><?php echo e(number_format($p->net_proprietaire ?? 0, 0, ',', ' ')); ?> F</td>
                            </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <tr>
                                <td colspan="8" style="padding:32px;text-align:center;color:#9ca3af">
                                    Aucun paiement enregistré pour <?php echo e($annee); ?>
                        ...
                        <tfoot>
                            <tr style="background:#f9fafb;font-weight:700">
                                <td colspan="4" style="padding:10px 14px;font-size:12px;color:#374151">TOTAL <?php echo e($annee); ?></td>
                                <td class="r" style="padding:10px 14px;font-family:'Syne',sans-serif"><?php echo e(number_format($paiements->sum(fn($p) => $p->loyer_ht ?? $p->loyer_nu ?? 0), 0, ',', ' ')); ?> F</td>
                                <td class="r" style="padding:10px 14px;color:#d97706;font-family:'Syne',sans-serif"><?php echo e(number_format($paiements->sum('tva_loyer'), 0, ',', ' ')); ?> F</td>
                                <td class="r" style="padding:10px 14px;color:#dc2626;font-family:'Syne',sans-serif"><?php echo e(number_format($paiements->sum('brs_amount'), 0, ',', ' ')); ?> F</td>
                                <td class="r" style="padding:10px 14px;color:#16a34a;font-family:'Syne',sans-serif"><?php echo e(number_format($paiements->sum('net_proprietaire'), 0, ',', ' ')); ?> F</td>
                            </tr>
                        </tfoot>
                        <?php endif; ?>
                    </table>
        ...
        <div class="sidebar-sticky">
            ...
            <div class="proprio-card" style="margin-bottom:16px">
                <div class="proprio-av"><?php echo e(strtoupper(substr($proprietaire->name, 0, 2))); ?></div>
                <div class="proprio-name"><?php echo e($proprietaire->name); ?></div>
                <div class="proprio-email"><?php echo e($proprietaire->email); ?></div>
                <div style="height:1px;background:rgba(255,255,255,.08);margin:14px 0"></div>
                <div class="meta-row">
                    <div class="meta-lbl">NINEA</div>
                    <div class="meta-val"><?php echo e($proprietaire->proprietaire?->ninea ?? '—'); ?></div>
                </div>
                <div class="meta-row">
                    <div class="meta-lbl">Tél</div>
                    <div class="meta-val"><?php echo e($proprietaire->telephone ?? '—'); ?></div>
                </div>
                <div class="meta-row">
                    <div class="meta-lbl">Biens</div>
                    <div class="meta-val"><?php echo e($bilan->nb_biens_geres); ?></div>
                </div>
                <div class="meta-row">
                    <div class="meta-lbl">Paiements</div>
                    <div class="meta-val"><?php echo e($bilan->nb_paiements); ?></div>
                </div>
            </div>
            ...
            <div class="card">
                <div style="padding:14px 18px;border-bottom:1px solid #e5e7eb">
                    <div style="font-size:11px;font-weight:600;text-transform:uppercase;letter-spacing:.8px;color:#9ca3af">Résumé fiscal <?php echo e($annee); ?></div>
                </div>
                <div style="padding:14px 18px">
                    ...
                    ?>
                    <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$lbl, $val, $clr]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div style="display:flex;justify-content:space-between;align-items:center;padding:8px 0;border-bottom:1px solid #f3f4f6;font-size:12px">
                        <span style="color:#6b7280"><?php echo e($lbl); ?></span>
                        <span style="font-family:'Syne',sans-serif;font-weight:700;color:<?php echo e($clr); ?>">
                            <?php echo e(($val < 0 ? '−' : '')); ?><?php echo e(number_format(abs($val), 0, ',', ' ')); ?> F
                        </span>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            ...
            <div class="card" style="margin-top:14px">
                <div style="padding:14px 18px">
                    ...
                    <div style="display:flex;flex-direction:column;gap:7px">
                        <a href="<?php echo e(route('admin.users.show', $proprietaire)); ?>"
                        ...
                        <a href="<?php echo e(route('admin.bilans-fiscaux.index')); ?>"
                           style="display:flex;align-items:center;gap:8px;padding:8px 12px;border:1px solid #e5e7eb;border-radius:8px;font-size:12px;color:#374151;text-decoration:none;transition:all .15s"
                           onmouseover="this.style.borderColor='#c9a84c'" onmouseout="this.style.borderColor='#e5e7eb'">
                        ...
                        <?php $__currentLoopData = $anneesDisponibles->reject(fn($a) => $a == $annee)->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $autreAnnee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route('admin.bilans-fiscaux.show', [$proprietaire, 'annee' => $autreAnnee])); ?>"
                           style="display:flex;align-items:center;gap:8px;padding:8px 12px;border:1px solid #e5e7eb;border-radius:8px;font-size:12px;color:#374151;text-decoration:none;transition:all .15s"
                           onmouseover="this.style.borderColor='#c9a84c'" onmouseout="this.style.borderColor='#e5e7eb'">
...
<?php endif; ?><?php /**PATH C:\Users\ph\bimotech-immo\resources\views/admin/bilans-fiscaux/show.blade.php ENDPATH**/ ?>