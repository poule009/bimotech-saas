...
<div class="page">
    ...
    <div style="display:flex;align-items:flex-start;justify-content:space-between;margin-bottom:22px">
        <div>
            ...
            <p style="font-size:13px;color:#6b7280;margin-top:3px"><?php echo e($stats['total']); ?> locataire(s) enregistré(s)</p>
        </div>
        <a href="<?php echo e(route('admin.users.create', 'locataire')); ?>" class="btn-add">
    ...
    <div class="kpi-row">
        ...
        <div class="kpi blue">
            ...
            <div class="kpi-val"><?php echo e($stats['total'] > 0 ? round($stats['actifs']/$stats['total']*100) : 0); ?>%</div>
            <div class="kpi-sub">Locataires actifs</div>
        </div>
        <div class="kpi red">
            <div class="kpi-lbl">Sans contrat</div>
            <div class="kpi-val"><?php echo e($stats['sans_contrat']); ?></div>
    ...
    <div class="card">
        ...
        <div style="overflow-x:auto">
            <table class="dt" id="dt-loc">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $locataires; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php
                    ...
                    ?>
                    <tr data-status="<?php echo e($aContrat ? 'actif' : 'sans'); ?>">
                        <td>
                            <div style="display:flex;align-items:center;gap:12px">
                                <div class="av <?php echo e($avClass); ?>"><?php echo e(strtoupper(substr($user->name,0,2))); ?></div>
                                <div>
                                    ...
                                    <div style="display:flex;align-items:center;gap:6px;margin-top:3px">
                                        ...
                                        <?php endif; ?>
                                        <span style="font-size:10px;color:#9ca3af">Depuis <?php echo e($user->created_at->format('M Y')); ?></span>
                                    </div>
                                </div>
                            </div>
                        </td>
                        <td>
                            <div style="font-size:12px;color:#374151"><?php echo e($user->email); ?></div>
                            <?php if($user->telephone): ?>
                            <div style="font-size:11px;color:#6b7280;margin-top:2px"><?php echo e($user->telephone); ?></div>
                            <?php endif; ?>
                        </td>
                        <td>
                            <?php if($profil?->profession): ?>
                                <div style="font-size:12px;font-weight:500;color:#374151"><?php echo e($profil->profession); ?></div>
                            <?php endif; ?>
                            <?php if($profil?->employeur): ?>
                                <div style="font-size:11px;color:#6b7280"><?php echo e($profil->employeur); ?></div>
                            <?php endif; ?>
                            <?php if(!$profil?->profession && !$profil?->employeur): ?>
                        ...
                        <td>
                            ...
                            <div class="contrat-mini">
                                <div class="contrat-mini-ref"><?php echo e($contratActif->bien->reference ?? '—'); ?></div>
                                <div class="contrat-mini-addr"><?php echo e($contratActif->bien->adresse ?? ''); ?>, <?php echo e($contratActif->bien->ville ?? ''); ?></div>
                                <div class="contrat-mini-loyer"><?php echo e(number_format($contratActif->loyer_contractuel, 0, ',', ' ')); ?> F/mois</div>
                            </div>
                            <?php else: ?>
                        ...
                        <td>
                            <div style="display:flex;align-items:center;justify-content:center;gap:5px">
                                ...
                                <?php if($waLink): ?>
                                <a href="<?php echo e($waLink); ?>" target="_blank" class="act wa" title="WhatsApp">
                                ...
                                <?php endif; ?>
                                <?php if($contratActif): ?>
                                <a href="<?php echo e(route('admin.paiements.create')); ?>?contrat_id=<?php echo e($contratActif->id); ?>" class="act" title="Enregistrer paiement"
                    ...
                    <tr>
                        <td colspan="6">
                            <div class="empty">
                                ...
                                <a href="<?php echo e(route('admin.users.create', 'locataire')); ?>" class="btn-add" style="display:inline-flex">
                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" style="width:14px;height:14px"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>
        ...
        <div style="padding:14px 22px;border-top:1px solid #f3f4f6"><?php echo e($locataires->links()); ?></div>
        <?php endif; ?>
    </div>
