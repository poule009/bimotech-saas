<?php $__env->startSection('title', 'Nouveau bien — Assistant'); ?>
<?php $__env->startSection('breadcrumb', 'Biens › Assistant de création'); ?>
...
<div style="padding: 0 0 60px; max-width: 960px">
    ...
    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:20px">
        ...
        <a href="<?php echo e(route('admin.biens.create')); ?>" style="display:inline-flex;align-items:center;gap:6px;padding:8px 14px;border:1px solid #e5e7eb;border-radius:9px;font-size:12px;color:#6b7280;text-decoration:none">
    ...
    <form method="POST" action="<?php echo e(route('admin.biens.store')); ?>" id="wz-form" novalidate>
        <?php echo csrf_field(); ?>
                ...
                <div class="wz-step-content active" id="step-1">
                    ...
                    <div class="card">
                            ...
                            <div class="form-row" style="margin-bottom:14px">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="loyer_mensuel" id="f-loyer" class="form-input"
                                           ...
                                           value="<?php echo e(old('loyer_mensuel')); ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="form-row" style="margin-bottom:14px">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="quartier" class="form-input"
                                           placeholder="ex: Almadies" value="<?php echo e(old('quartier')); ?>">
                                </div>
                                <div class="form-group">
                                    <label class="form-label">Ville <span class="req">*</span></label>
                                    <input type="text" name="ville" id="f-ville" class="form-input"
                                           placeholder="ex: Dakar" required value="<?php echo e(old('ville')); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-row" style="margin-bottom:14px">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="surface_m2" class="form-input"
                                           placeholder="ex: 120" min="1" value="<?php echo e(old('surface_m2')); ?>">
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="number" name="nombre_pieces" class="form-input"
                                           placeholder="ex: 4" min="1" value="<?php echo e(old('nombre_pieces')); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="taux_commission" class="form-input"
                                           ...
                                           value="<?php echo e(old('taux_commission')); ?>">
                                </div>
                                <div class="form-group" style="display:flex;align-items:flex-end;padding-bottom:2px">
                                    <label style="display:flex;align-items:center;gap:8px;cursor:pointer;font-size:13px;color:#374151">
                                        <input type="checkbox" name="meuble" value="1"
                                               <?php if(old('meuble')): echo 'checked'; endif; ?>
                        ...
                        <div class="wz-actions">
                            <a href="<?php echo e(route('admin.biens.index')); ?>" class="btn-prev">
                                Annuler
                            </a>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div style="padding:24px;text-align:center;background:#fafafa;border-radius:10px;border:1px dashed #e5e7eb">
                                ...
                                <a href="<?php echo e(route('admin.users.proprietaires')); ?>" target="_blank"
                            ...
                            <div class="person-grid" id="prop-grid">
                                <?php $__currentLoopData = $proprietaires; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <label class="person-card" onclick="selectPerson(this, 'proprietaire_id', <?php echo e($prop->id); ?>, '<?php echo e(addslashes($prop->name)); ?>', '<?php echo e(addslashes($prop->email)); ?>')">
                                    <input type="radio" name="proprietaire_id" value="<?php echo e($prop->id); ?>" <?php if(old('proprietaire_id') == $prop->id): echo 'checked'; endif; ?>>
                                    <div class="person-avatar" style="background:rgba(29,78,216,.1);color:#1d4ed8">
                                        <?php echo e(strtoupper(substr($prop->name, 0, 1))); ?>

                                    </div>
                                    <div style="flex:1;min-width:0">
                                        <div class="person-name"><?php echo e($prop->name); ?></div>
                                        <div class="person-email"><?php echo e($prop->email); ?></div>
                                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="person-grid" id="loc-grid">
                                ...
                                <label class="person-card" onclick="selectPerson(this, 'locataire_id_wizard', <?php echo e($loc->id); ?>, '<?php echo e(addslashes($loc->name)); ?>', '<?php echo e(addslashes($loc->telephone ?? $loc->email)); ?>')">
                                    <input type="radio" name="locataire_id_wizard" value="<?php echo e($loc->id); ?>">
                                    <div class="person-avatar" style="background:rgba(22,163,74,.1);color:#16a34a">
                                        <?php echo e(strtoupper(substr($loc->name, 0, 1))); ?>

                                    </div>
                                    <div style="flex:1;min-width:0">
                                        <div class="person-name"><?php echo e($loc->name); ?></div>
                                        <div class="person-email"><?php echo e($loc->telephone ?? $loc->email); ?></div>
                                    </div>
                                    <div class="person-check">
                                        <svg style="width:10px;height:10px;color:#fff" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><polyline points="20 6 9 17 4 12"/></svg>
                                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ph\bimotech-immo\resources\views/biens/wizard.blade.php ENDPATH**/ ?>