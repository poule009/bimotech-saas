...
<?php $component->withAttributes([]); ?>
    ...
    <div class="flex-between section-gap" style="flex-wrap:wrap;gap:12px;">
        <div>
            ...
            <p style="font-size:13px;color:var(--text-3);margin-top:3px;"><?php echo e($periode->translatedFormat('F Y')); ?></p>
        </div>
        <form method="GET" action="<?php echo e(route('admin.impayes.index')); ?>"
            ...
            <select name="annee" style="border:1.5px solid var(--border);border-radius:var(--radius-sm);padding:8px 12px;font-size:13px;color:var(--text);background:var(--surface);outline:none;font-family:inherit;cursor:pointer;">
                <?php $__currentLoopData = range(now()->year - 1, now()->year); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div style="display:grid;grid-template-columns:repeat(2,1fr);gap:10px;" class="section-gap" id="impayes-kpi">
        <div class="kpi" style="border-color:#fecaca;background:#fef2f2;">
            ...
            <div class="kpi-value" style="color:#dc2626;"><?php echo e($stats['nb_impayes']); ?></div>
        ...
        <div class="kpi" style="border-color:#bbf7d0;background:#f0fdf4;">
            ...
            <div class="kpi-value" style="color:#16a34a;"><?php echo e($stats['nb_payes']); ?></div>
        ...
        <div class="kpi" style="border-color:#fde68a;background:#fffbeb;">
            ...
            <div class="kpi-value text-money" style="color:#d97706;font-size:18px;">
                <?php echo e(number_format($stats['montant_du'], 0, ',', ' ')); ?> <span style="font-size:12px;font-weight:500;">FCFA</span>
            </div>
        </div>
        <div class="kpi">
            ...
            ?>
            <div class="kpi-value" style="color:<?php echo e($tauxColor); ?>;"><?php echo e($taux); ?>%</div>
            <div class="progress" style="margin-top:8px;">
                <div class="progress-bar" style="width:<?php echo e($taux); ?>%;background:<?php echo e($barColor); ?>;"></div>
            </div>
        </div>
    </div>
    ...
    <?php if($impayes->isNotEmpty()): ?>
        ...
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:12px;">
            <div style="display:flex;align-items:center;gap:8px;">
                ...
                <span style="font-size:15px;font-weight:700;color:#dc2626;">
                    Loyers impayés — <?php echo e($impayes->count()); ?> contrat(s)
                </span>
            </div>
            <span style="font-size:13px;font-weight:600;color:#dc2626;">
                Total dû : <?php echo e(number_format($stats['montant_du'], 0, ',', ' ')); ?> FCFA
            </span>
        </div>
            ...
            <?php $__currentLoopData = $impayes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="mobile-card" style="border-color:#fecaca;background:#fff9f9;">
                    <div class="flex-between" style="margin-bottom:10px;">
                        <div>
                            <div style="font-weight:700;font-size:14px;color:var(--text);"><?php echo e($item['contrat']->bien->reference); ?></div>
                            <div style="font-size:11px;color:var(--text-3);"><?php echo e($item['contrat']->bien->ville); ?></div>
                        </div>
                        <?php if($item['jours_retard'] > 0): ?>
                            <span class="badge <?php echo e($item['jours_retard'] > 15 ? 'badge-red' : 'badge-amber'); ?>">
                                <?php echo e($item['jours_retard']); ?>j de retard
                            </span>
                        <?php else: ?>
                    ...
                    <div class="mobile-card-row">
                        ...
                        <span class="mobile-card-value"><?php echo e($item['contrat']->locataire->name); ?></span>
                    </div>
                    <div class="mobile-card-row">
                        ...
                        <span class="mobile-card-value">
                            ...
                            ?>
                            <?php if($telBrut): ?>
                                <a href="tel:<?php echo e($telBrut); ?>" style="color:var(--agency);font-weight:600;text-decoration:none;">
                                    📞 <?php echo e($telBrut); ?>
                    ...
                    <div class="mobile-card-row">
                        ...
                        <span class="mobile-card-value"><?php echo e($item['contrat']->bien->proprietaire->name); ?></span>
                    </div>
        ...
        <div class="desktop-table card section-gap" style="border-color:#fecaca;">
            <div style="padding:14px 20px;border-bottom:1px solid #fecaca;background:#fef2f2;display:flex;align-items:center;justify-content:space-between;">
                <span style="font-size:14px;font-weight:700;color:#dc2626;">⚠️ Loyers impayés — <?php echo e($impayes->count()); ?> contrat(s)</span>
                <span style="font-size:13px;color:#dc2626;font-weight:600;">Total dû : <?php echo e(number_format($stats['montant_du'], 0, ',', ' ')); ?> FCFA</span>
            </div>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $impayes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr style="background:#fff9f9;" onmouseenter="this.style.background='#fef2f2'" onmouseleave="this.style.background='#fff9f9'">
                                <td>
                                    <div style="font-weight:600;font-size:13px;"><?php echo e($item['contrat']->bien->reference); ?></div>
                                    <div style="font-size:11px;color:var(--text-3);"><?php echo e($item['contrat']->bien->ville); ?></div>
                                </td>
                                <td>
                                    <div style="font-size:13px;font-weight:500;"><?php echo e($item['contrat']->locataire->name); ?></div>
                                    <div style="font-size:11px;color:var(--text-3);"><?php echo e($item['contrat']->locataire->email); ?></div>
                                </td>
    ...
    <?php else: ?>
        <div class="card section-gap" style="border-color:#bbf7d0;background:#f0fdf4;text-align:center;padding:48px 20px;">
            ...
            <div style="font-size:13px;color:#22c55e;">Aucun impayé pour <?php echo e($periode->translatedFormat('F Y')); ?></div>
        </div>
    <?php endif; ?>
    ...
    <?php if($payes->isNotEmpty()): ?>
        ...
        <div style="font-size:15px;font-weight:700;color:var(--text);margin-bottom:12px;">
            ✅ Loyers reçus — <?php echo e($payes->count()); ?> paiement(s)
        </div>
            ...
            <?php $__currentLoopData = $payes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="mobile-card">
                    <div class="mobile-card-row">
                        ...
                        <span style="font-weight:700;color:var(--text);"><?php echo e($item['contrat']->bien->reference); ?></span>
                    </div>
                    <div class="mobile-card-row">
                        <span class="mobile-card-label">Locataire</span>
                        <span class="mobile-card-value"><?php echo e($item['contrat']->locataire->name); ?></span>
                    ...
                    <div class="mobile-card-row">
                        ...
                        <span class="badge badge-gray"><?php echo e(ucfirst(str_replace('_', ' ', $item['paiement']->mode_paiement))); ?></span>
                    </div>
                    <div style="border-top:1px solid var(--border);margin-top:8px;padding-top:8px;">
                        <div class="mobile-card-row">
                            <span class="mobile-card-label">Montant</span>
                            <span style="font-weight:700;" class="text-money"><?php echo e(number_format($item['paiement']->montant_encaisse, 0, ',', ' ')); ?> F</span>
                        </div>
                        <div class="mobile-card-row">
                            <span class="mobile-card-label">Net proprio</span>
                            <span style="color:#16a34a;font-weight:700;" class="text-money"><?php echo e(number_format($item['paiement']->net_proprietaire, 0, ',', ' ')); ?> F</span>
                        </div>
                    </div>
            ...
            <div class="table-wrap">
                <table>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $payes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td style="font-weight:600;font-size:13px;"><?php echo e($item['contrat']->bien->reference); ?></td>
                                <td style="font-size:13px;color:var(--text-2);"><?php echo e($item['contrat']->locataire->name); ?></td>
                                <td>
                                    <span class="badge badge-gray">
                                        <?php echo e(ucfirst(str_replace('_', ' ', $item['paiement']->mode_paiement))); ?>
