    ...
    <nav class="fixed top-0 left-0 right-0 z-50 bg-white border-b border-gray-100 shadow-sm">
        <div class="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="<?php echo e(route('agency.register')); ?>"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <?php $__currentLoopData = $features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6 hover:shadow-md transition">
                        ...
                        <h3 class="font-bold text-gray-900 text-lg mb-2"><?php echo e($feature['titre']); ?></h3>
                        <p class="text-gray-500 text-sm leading-relaxed"><?php echo e($feature['desc']); ?></p>
                    </div>
        ...
        <div class="max-w-6xl mx-auto px-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
                ...
                <?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white rounded-xl border-2 <?php echo e($plan['populaire'] ? 'border-blue-400 shadow-lg' : 'border-gray-200 shadow-sm'); ?> p-6 flex flex-col relative">
                        ...
                        <div class="mb-1">
                            <span class="text-3xl font-black text-gray-900"><?php echo e($plan['prix']); ?></span>
                            <span class="text-base text-gray-500"> FCFA</span>
                        </div>
                        <p class="text-sm text-gray-400 mb-2"><?php echo e($plan['duree']); ?></p>
                        <?php if($plan['eco']): ?>
                            <p class="text-sm text-green-600 font-semibold mb-4">
                                Économisez <?php echo e($plan['eco']); ?>
    ...
    <section id="contact" class="py-16 bg-gray-900 text-white">
        <div class="max-w-6xl mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
                ...
                <div>
                    ...
                    <div class="space-y-2 text-sm">
                        <p>
                            <a href="<?php echo e(route('agency.register')); ?>" class="text-gray-400 hover:text-white transition">
                                → Créer un compte
                            </a>
                        </p>
                        <p>
                            <a href="<?php echo e(route('login')); ?>" class="text-gray-400 hover:text-white transition">
                                → Se connecter
                            </a>
                        </p>
                        <p>
            ...
            <div class="border-t border-gray-700 mt-10 pt-6 text-center text-xs text-gray-500">
                © <?php echo e(date('Y')); ?> BIMO-Tech. Tous droits réservés. Conçu au Sénégal 🇸🇳
            </div>
...
<?php /**PATH C:\Users\ph\bimotech-immo\resources\views/landing.blade.php ENDPATH**/ ?>