...
<?php $__env->startSection('breadcrumb', 'Contrats › Nouveau'); ?>
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <select name="bien_id" id="bien_id"
                                    class="form-select <?php echo e($errors->has('bien_id') ? 'error':''); ?>"
                                ...
                                <?php $__currentLoopData = $biens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bien): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($bien->id); ?>"
                                        ...
                                        data-proprio="<?php echo e($bien->proprietaire?->name); ?>"
                                        data-meuble="<?php echo e($bien->meuble ? '1':'0'); ?>"
                                        data-type="<?php echo e($bien->type); ?>"
                        ...
                        <div class="form-group">
                            ...
                            <select name="locataire_id" id="locataire_id"
                                ...
                                <?php $__currentLoopData = $locataires; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $loc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($loc->id); ?>" <?php echo e(old('locataire_id') == $loc->id ? 'selected':''); ?>>
                                        <?php echo e($loc->name); ?> — <?php echo e($loc->email); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="date_fin"
                                       class="form-input" value="<?php echo e(old('date_fin')); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <select name="type_bail" id="type_bail"
                                    class="form-select <?php echo e($errors->has('type_bail') ? 'error':''); ?>"
                                ...
                                <?php $__currentLoopData = $typesBail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($val); ?>" <?php echo e(old('type_bail', 'habitation') === $val ? 'selected':''); ?>>
                                        <?php echo e($label); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="reference_bail"
                                   class="form-input" value="<?php echo e(old('reference_bail')); ?>"
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="number" name="loyer_nu" id="loyer_nu"
                                       ...
                                       value="<?php echo e(old('loyer_nu', $bienPreselectionne?->loyer_mensuel)); ?>"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="charges_mensuelles" id="charges_mensuelles"
                                       class="form-input" value="<?php echo e(old('charges_mensuelles', 0)); ?>"
                                       min="0" step="500" oninput="mettreAJourRecap()">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="number" name="tom_amount" id="tom_amount"
                                       class="form-input" value="<?php echo e(old('tom_amount', 0)); ?>"
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="indexation_annuelle"
                                       class="form-input" value="<?php echo e(old('indexation_annuelle', 0)); ?>"
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="number" name="caution" id="caution"
                                       ...
                                       value="<?php echo e(old('caution')); ?>" min="0" step="500">
                            ...
                            <div class="form-group">
                                ...
                                <select name="nombre_mois_caution" id="nombre_mois_caution"
                                    ...
                                    <?php $__currentLoopData = [1,2,3,6]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($n); ?>" <?php echo e(old('nombre_mois_caution', 1) == $n ? 'selected':''); ?>>
                                            <?php echo e($n); ?> mois
                                        </option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="text" name="garant_nom" class="form-input"
                                       value="<?php echo e(old('garant_nom')); ?>" placeholder="Prénom Nom">
                            </div>
                            <div class="form-group">
                                <label class="form-label">Téléphone</label>
                                <input type="text" name="garant_telephone" class="form-input"
                                       value="<?php echo e(old('garant_telephone')); ?>" placeholder="+221 7X XXX XX XX">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Adresse</label>
                            <input type="text" name="garant_adresse" class="form-input"
                                   value="<?php echo e(old('garant_adresse')); ?>" placeholder="Adresse complète">
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <textarea name="observations" class="form-textarea"
                            placeholder="Clauses particulières, état des lieux…"><?php echo e(old('observations')); ?></textarea>
                    </div>
...
const biensData = <?php echo json_encode($biens->keyBy('id'), 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ph\bimotech-immo\resources\views/admin/contrats/create.blade.php ENDPATH**/ ?>