    ...
    <label style="display:flex;align-items:center;gap:10px;cursor:pointer">
        ...
        <span style="position:relative;display:inline-block;width:40px;height:22px;flex-shrink:0">
            ...
            <input type="checkbox" name="caution_gardee_par_agence" id="caution_gardee_par_agence" value="1"
                   <?php echo e(old('caution_gardee_par_agence', $contrat?->caution_gardee_par_agence ?? false) ? 'checked' : ''); ?>
            ...
            <span id="switch-track" onclick="document.getElementById('caution_gardee_par_agence').click()"
                  ...
                  background:<?php echo e(old('caution_gardee_par_agence', $contrat?->caution_gardee_par_agence ?? false) ? '#c9a84c' : '#d1d5db'); ?>">
                <span id="switch-knob"
                      style="position:absolute;top:3px;width:16px;height:16px;border-radius:50%;background:#fff;transition:.2s;
                      left:<?php echo e(old('caution_gardee_par_agence', $contrat?->caution_gardee_par_agence ?? false) ? '21px' : '3px'); ?>"></span>
            </span>
        </span>
        <span>
            ...
            <span id="caution-policy-label" style="display:block;font-size:11px;margin-top:1px;
                  color:<?php echo e(old('caution_gardee_par_agence', $contrat?->caution_gardee_par_agence ?? false) ? '#8a6e2f' : '#16a34a'); ?>">
                <?php echo e(old('caution_gardee_par_agence', $contrat?->caution_gardee_par_agence ?? false)
