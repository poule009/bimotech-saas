...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <div class="sidebar-logo">
            <?php if(isset($currentAgency)): ?>
                <?php if($currentAgency?->logo_path): ?>
                    <img src="<?php echo e(Storage::url($currentAgency->logo_path)); ?>"
                         alt="<?php echo e($currentAgency->name); ?>"
        ...
        <nav class="sidebar-nav">
            <?php if(auth()->user()->isAdmin()): ?>
                ...
                <a href="<?php echo e(route('admin.paiements.index')); ?>"
                   class="nav-item <?php echo e(request()->routeIs('admin.paiements.*') ? 'active' : ''); ?>">
                ...
                <a href="<?php echo e(route('admin.contrats.index')); ?>"
                   class="nav-item <?php echo e(request()->routeIs('admin.contrats.*') ? 'active' : ''); ?>">
                ...
                <a href="<?php echo e(route('biens.index')); ?>"
                   class="nav-item <?php echo e(request()->routeIs('biens.*') ? 'active' : ''); ?>">
                ...
                <a href="<?php echo e(route('admin.users.proprietaires')); ?>"
                   class="nav-item <?php echo e(request()->routeIs('admin.users.proprietaires') ? 'active' : ''); ?>">
                ...
                <a href="<?php echo e(route('admin.users.locataires')); ?>"
                   class="nav-item <?php echo e(request()->routeIs('admin.users.locataires') ? 'active' : ''); ?>">
                ...
                <a href="<?php echo e(route('admin.rapports.financier')); ?>"
                   class="nav-item <?php echo e(request()->routeIs('admin.rapports.*') ? 'active' : ''); ?>">
                ...
                <a href="<?php echo e(route('admin.impayes.index')); ?>"
                   class="nav-item <?php echo e(request()->routeIs('admin.impayes.*') ? 'active' : ''); ?>">
            ...
            <?php elseif(auth()->user()->isProprietaire()): ?>
                <a href="<?php echo e(route('proprietaire.dashboard')); ?>"
                   class="nav-item <?php echo e(request()->routeIs('proprietaire.dashboard') ? 'active' : ''); ?>">
                    <svg fill="none" stroke="currentColor" stroke-width="1.75" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
                    Dashboard
                </a>
                <a href="<?php echo e(route('biens.index')); ?>"
            ...
            <?php elseif(auth()->user()->isLocataire()): ?>
                <a href="<?php echo e(route('locataire.dashboard')); ?>"
                   class="nav-item <?php echo e(request()->routeIs('locataire.dashboard') ? 'active' : ''); ?>">
                    <svg fill="none" stroke="currentColor" stroke-width="1.75" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
                    Dashboard
                </a>
                <a href="<?php echo e(route('locataire.paiements')); ?>"
                   class="nav-item <?php echo e(request()->routeIs('locataire.paiements') ? 'active' : ''); ?>">
                    <svg fill="none" stroke="currentColor" stroke-width="1.75" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                    Mes Reçus
                </a>
            <?php endif; ?>
        ...
        <div class="sidebar-footer">
            <?php if(isset($currentAgency) && $currentAgency?->subscription?->estEnEssai()): ?>
                <div class="trial-badge">
                    <span>🕐</span>
                    <span>Essai — <?php echo e($currentAgency->subscription->joursRestantsEssai()); ?>j</span>
                    <a href="<?php echo e(route('subscription.index')); ?>">S'abonner</a>
                </div>
            <?php endif; ?>
            ...
            <div style="position:relative;">
                ...
                <div class="dropdown" id="dropdown">
                    ...
                    <?php if(auth()->user()->isAdmin()): ?>
                        <a href="<?php echo e(route('admin.agency.settings')); ?>" class="dropdown-item">
                        ...
                        <a href="<?php echo e(route('subscription.index')); ?>" class="dropdown-item">
    ...
    <div class="main">
        ...
        <header class="topbar">
            ...
            <?php else: ?>
                <span style="font-weight:700;font-size:14px;"><?php echo e($currentAgency?->name ?? 'Bimotech'); ?></span>
            <?php endif; ?>
    ...
    <nav class="tabbar">
        <?php if(auth()->user()->isAdmin()): ?>
            ...
            <a href="<?php echo e(route('biens.index')); ?>" class="tab-item <?php echo e(request()->routeIs('biens.*') ? 'active' : ''); ?>">
                <svg fill="none" stroke="currentColor" stroke-width="1.75" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-2 10v-5a1 1 0 00-1-1h-2a1 1 0 00-1 1v5m4 0H9"/></svg>
                <span>Biens</span>
            </a>
            <a href="<?php echo e(route('admin.paiements.index')); ?>" class="tab-item <?php echo e(request()->routeIs('admin.paiements.*') ? 'active' : ''); ?>">
                <svg fill="none" stroke="currentColor" stroke-width="1.75" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z"/></svg>
                <span>Paiements</span>
            </a>
            <a href="<?php echo e(route('admin.contrats.index')); ?>" class="tab-item <?php echo e(request()->routeIs('admin.contrats.*') ? 'active' : ''); ?>">
                <svg fill="none" stroke="currentColor" stroke-width="1.75" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                <span>Contrats</span>
            </a>
            <a href="<?php echo e(route('admin.impayes.index')); ?>" class="tab-item <?php echo e(request()->routeIs('admin.impayes.*') ? 'active' : ''); ?>" style="position:relative;">
                <?php if(($impayes_count ?? 0) > 0): ?>
                    <span style="position:absolute;top:2px;right:calc(50% - 18px);background:#dc2626;color:white;font-size:9px;font-weight:700;padding:1px 4px;border-radius:999px;line-height:1.4;min-width:14px;text-align:center;"><?php echo e($impayes_count); ?></span>
                <?php endif; ?>
                <svg fill="none" stroke="currentColor" stroke-width="1.75" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/></svg>
                <span>Impayés</span>
            </a>
        ...
        <?php elseif(auth()->user()->isProprietaire()): ?>
            <a href="<?php echo e(route('proprietaire.dashboard')); ?>" class="tab-item <?php echo e(request()->routeIs('proprietaire.dashboard') ? 'active' : ''); ?>">
                <svg fill="none" stroke="currentColor" stroke-width="1.75" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
                <span>Accueil</span>
            </a>
            <a href="<?php echo e(route('biens.index')); ?>" class="tab-item <?php echo e(request()->routeIs('biens.*') ? 'active' : ''); ?>">
        ...
        <?php elseif(auth()->user()->isLocataire()): ?>
            <a href="<?php echo e(route('locataire.dashboard')); ?>" class="tab-item <?php echo e(request()->routeIs('locataire.dashboard') ? 'active' : ''); ?>">
                <svg fill="none" stroke="currentColor" stroke-width="1.75" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
                <span>Accueil</span>
            </a>
            <a href="<?php echo e(route('locataire.paiements')); ?>" class="tab-item <?php echo e(request()->routeIs('locataire.paiements') ? 'active' : ''); ?>">
                <svg fill="none" stroke="currentColor" stroke-width="1.75" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                <span>Mes Reçus</span>
            </a>
        <?php endif; ?>
...
<?php /**PATH C:\Users\ph\bimotech-immo\resources\views/layouts/app.blade.php ENDPATH**/ ?>