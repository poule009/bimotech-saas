...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="field">
                <label>Objet *</label>
                <select name="objet">
                    <option value="" disabled <?php echo e(old('objet') ? '' : 'selected'); ?>>Sélectionner un objet</option>
                    <option value="demo"      <?php echo e(old('objet') === 'demo'      ? 'selected' : ''); ?>>Demander une démo</option>
                    <option value="tarif"     <?php echo e(old('objet') === 'tarif'     ? 'selected' : ''); ?>>Question sur les tarifs</option>
                    <option value="technique" <?php echo e(old('objet') === 'technique' ? 'selected' : ''); ?>>Question technique</option>
                    <option value="reseau"    <?php echo e(old('objet') === 'reseau'    ? 'selected' : ''); ?>>Plan Réseau / multi-agences</option>
                    <option value="autre"     <?php echo e(old('objet') === 'autre'     ? 'selected' : ''); ?>>Autre</option>
                </select>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="field">
                <label>Message *</label>
                <textarea name="message" placeholder="Décrivez votre besoin, le nombre de biens que vous gérez, votre ville..."><?php echo e(old('message')); ?></textarea>
...
</html><?php /**PATH C:\Users\ph\bimotech-immo\resources\views/contact.blade.php ENDPATH**/ ?>