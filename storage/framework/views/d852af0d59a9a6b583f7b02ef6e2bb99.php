...
<div class="main">
    ...
    <?php $__currentLoopData = $faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categorie => $questions): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="cat-label"><?php echo e($categorie); ?></div>

        <?php $__currentLoopData = $questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="faq-item" id="faq-<?php echo e($loop->parent->index); ?>-<?php echo e($loop->index); ?>">
                ...
                <div class="faq-a"><p><?php echo e($faq['a']); ?></p></div>
            </div>
    ...
    <div class="cta-box">
        ...
        <div class="cta-btns">
            <a href="<?php echo e(route('demo')); ?>" class="btn-gold">Réserver une démo →</a>
            <a href="<?php echo e(route('contact')); ?>" class="btn-outline">Nous contacter</a>
        </div>
    </div>
...
</html><?php /**PATH C:\Users\ph\bimotech-immo\resources\views/faq.blade.php ENDPATH**/ ?>