...
<div style="padding:24px 32px 48px">
    ...
    <div style="display:flex;align-items:flex-start;justify-content:space-between;margin-bottom:22px">
        <div>
            ...
            <p style="font-size:13px;color:#6b7280;margin-top:3px">
                <?php echo e($debutMois->translatedFormat('F Y')); ?> · <?php echo e($currentAgency->name ?? 'Votre agence'); ?>
    ...
    <form method="GET" action="<?php echo e(route('admin.rapports.financier')); ?>">
        <div class="filter-bar">
            ...
            ?>
            <a href="<?php echo e(route('admin.rapports.financier', ['mois'=>$prevM,'annee'=>$prevA])); ?>"
               class="btn-outline">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="15 18 9 12 15 6"/></svg>
                Mois préc.
            </a>
            <?php if(!($mois == now()->month && $annee == now()->year)): ?>
            <a href="<?php echo e(route('admin.rapports.financier', ['mois'=>$nextM,'annee'=>$nextA])); ?>"
               class="btn-outline">
                Mois suiv.
    ...
    <div class="kpi-row">
        <div class="kpi-mini gold">
            ...
            <div class="kpi-val gold"><?php echo e(number_format($kpiMois['total_loyers'], 0, ',', ' ')); ?><span class="kpi-u">F</span></div>
            <div class="kpi-s"><?php echo e($kpiMois['nb_paiements']); ?> paiements</div>
        </div>
        <div class="kpi-mini green">
            <div class="kpi-lbl">Net propriétaires</div>
            <div class="kpi-val green"><?php echo e(number_format($kpiMois['total_net_proprio'], 0, ',', ' ')); ?><span class="kpi-u">F</span></div>
            <div class="kpi-s">Après commission</div>
        </div>
        <div class="kpi-mini blue">
            <div class="kpi-lbl">Commission HT</div>
            <div class="kpi-val" style="color:#1d4ed8"><?php echo e(number_format($kpiMois['total_commission'], 0, ',', ' ')); ?><span class="kpi-u">F</span></div>
            <div class="kpi-s">Revenu agence</div>
        </div>
        <div class="kpi-mini orange">
            <div class="kpi-lbl">TVA à reverser DGI</div>
            <div class="kpi-val orange"><?php echo e(number_format($kpiMois['total_tva'], 0, ',', ' ')); ?><span class="kpi-u">F</span></div>
            <div class="kpi-s">18% sur commission</div>
        </div>
        <div class="kpi-mini red">
            <div class="kpi-lbl">Commission TTC</div>
            <div class="kpi-val" style="color:#0d1117"><?php echo e(number_format($kpiMois['total_ttc'], 0, ',', ' ')); ?><span class="kpi-u">F</span></div>
    ...
    <div class="bilan">
        <div class="bilan-col">
            ...
            <div class="bilan-val gold"><?php echo e(number_format($kpiMois['total_loyers'], 0, ',', ' ')); ?><span class="bilan-u">F</span></div>
            <div class="bilan-s"><?php echo e($kpiMois['nb_paiements']); ?> paiements validés</div>
        </div>
        <div class="bilan-col">
            <div class="bilan-lbl">Net reversé aux propriétaires</div>
            <div class="bilan-val green"><?php echo e(number_format($kpiMois['total_net_proprio'], 0, ',', ' ')); ?><span class="bilan-u">F</span></div>
            <div class="bilan-s">Après déduction commission</div>
        </div>
        <div class="bilan-col">
            <div class="bilan-lbl">Commission TTC agence</div>
            <div class="bilan-val orange"><?php echo e(number_format($kpiMois['total_ttc'], 0, ',', ' ')); ?><span class="bilan-u">F</span></div>
            <div class="bilan-s">Dont <?php echo e(number_format($kpiMois['total_tva'], 0, ',', ' ')); ?> F de TVA</div>
        </div>
        <div class="bilan-col">
            <div class="bilan-lbl">Impayés ce mois</div>
            <div class="bilan-val <?php echo e($biensImpayés->isEmpty() ? 'green' : 'red'); ?>">
                <?php echo e($biensImpayés->count()); ?><span class="bilan-u">contrats</span>
            </div>
            <div class="bilan-s">
                <?php if($biensImpayés->isEmpty()): ?> Recouvrement complet
                <?php else: ?> <?php echo e(number_format($biensImpayés->sum('loyer_contractuel'), 0, ',', ' ')); ?> F à recouvrer
                <?php endif; ?>
            </div>
        </div>
    </div>
    ...
    <div class="impaye-alert">
        ...
        <div class="impaye-grid">
            ...
            <div class="impaye-item">
                <div class="impaye-item-ref"><?php echo e($c->bien->reference); ?></div>
                <div class="impaye-item-name"><?php echo e($c->locataire->name); ?></div>
                <div class="impaye-item-amt"><?php echo e(number_format($c->loyer_contractuel, 0, ',', ' ')); ?> F</div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
        <div style="margin-top:14px">
            <a href="<?php echo e(route('admin.impayes.index', ['mois'=>$mois,'annee'=>$annee])); ?>"
    ...
    <div class="g2">
        ...
        <div class="card">
            ...
            <div class="chart-meta">
                <div>
                    <div class="chart-num"><?php echo e(number_format($kpiMois['total_loyers'], 0, ',', ' ')); ?> F</div>
                    <div class="chart-sub">Ce mois · <?php echo e($debutMois->translatedFormat('F Y')); ?></div>
                </div>
            </div>
        ...
        <div class="card">
            ...
            <div class="stats-grid">
                <div class="stat-item">
                    <div class="stat-val"><?php echo e($statsGenerales['nb_biens']); ?></div>
                    <div class="stat-lbl">Biens gérés</div>
                </div>
                <div class="stat-item">
                    <div class="stat-val" style="color:#16a34a"><?php echo e($statsGenerales['nb_biens_loues']); ?></div>
                    <div class="stat-lbl">Biens loués</div>
                </div>
                <div class="stat-item">
                    <div class="stat-val" style="color:#1d4ed8"><?php echo e($statsGenerales['taux_occupation']); ?>%</div>
                    <div class="stat-lbl">Occupation</div>
                </div>
                <div class="stat-item">
                    <div class="stat-val"><?php echo e($statsGenerales['nb_contrats']); ?></div>
                    <div class="stat-lbl">Contrats actifs</div>
                </div>
                <div class="stat-item">
                    <div class="stat-val"><?php echo e($statsGenerales['nb_proprietaires']); ?></div>
                    <div class="stat-lbl">Propriétaires</div>
                </div>
                <div class="stat-item">
                    <div class="stat-val"><?php echo e($statsGenerales['nb_locataires']); ?></div>
            ...
            <div class="donut-legend" style="justify-content:center">
                <div class="donut-leg"><div class="donut-dot" style="background:#4ade80"></div>Net proprio <?php echo e($kpiMois['total_loyers'] > 0 ? round(($kpiMois['total_net_proprio']/$kpiMois['total_loyers'])*100) : 0); ?>%</div>
                <div class="donut-leg"><div class="donut-dot" style="background:#c9a84c"></div>Comm. HT <?php echo e($kpiMois['total_loyers'] > 0 ? round(($kpiMois['total_commission']/$kpiMois['total_loyers'])*100) : 0); ?>%</div>
                <div class="donut-leg"><div class="donut-dot" style="background:#fbbf24"></div>TVA <?php echo e($kpiMois['total_loyers'] > 0 ? round(($kpiMois['total_tva']/$kpiMois['total_loyers'])*100) : 0); ?>%</div>
            </div>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-hd">
            ...
            <div style="font-size:12px;color:#6b7280"><?php echo e($parProprietaire->count()); ?> propriétaire(s) · cliquez pour détailler</div>
        </div>
        <div style="overflow-x:auto">
            <table class="dt" id="proprio-table">
                ...
                <tbody>
                    <?php $__currentLoopData = $parProprietaire; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proprioId => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php $toggleId = 'detail-'.$proprioId; ?>

                    
                    <tr class="proprio-row" onclick="toggleDetail('<?php echo e($toggleId); ?>', this)">
                        <td>
                            <div class="proprio-name"><?php echo e($data['proprio']->name); ?></div>
                            <div class="proprio-count"><?php echo e($data['nb_paiements']); ?> bien(s) ce mois</div>
                        </td>
                        <td class="td-r"><span class="amt-main"><?php echo e(number_format($data['loyers'], 0, ',', ' ')); ?> F</span></td>
                        <td class="td-r"><span class="amt-gold"><?php echo e(number_format($data['commission'], 0, ',', ' ')); ?> F</span></td>
                        <td class="td-r"><span class="amt-green"><?php echo e(number_format($data['net'], 0, ',', ' ')); ?> F</span></td>
                        <td class="td-c">
                            <span class="badge g"><span class="bdot"></span><?php echo e($data['nb_paiements']); ?></span>
                        </td>
                        <td class="td-c">
                            <svg style="width:14px;height:14px;color:#9ca3af;transition:transform .2s" class="chevron-<?php echo e($proprioId); ?>" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="6 9 12 15 18 9"/></svg>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="6" style="padding:0;border:none">
                            <div id="<?php echo e($toggleId); ?>" style="display:none;background:#f9fafb;border-top:1px solid #e5e7eb">
                                <table style="width:100%;border-collapse:collapse">
                                    ...
                                    <tbody>
                                        ...
                                        <tr style="border-bottom:1px solid #e5e7eb">
                                            <td style="padding:10px 18px 10px 36px;font-size:12px;font-weight:500;color:#0d1117"><?php echo e($p->contrat->bien->reference); ?></td>
                                            <td style="padding:10px 18px;font-size:12px;color:#6b7280"><?php echo e($p->contrat->locataire->name); ?></td>
                                            <td style="padding:10px 18px;font-size:12px;color:#6b7280"><?php echo e(\App\Models\Paiement::MODES_PAIEMENT[$p->mode_paiement] ?? $p->mode_paiement); ?></td>
                                            <td style="padding:10px 18px;text-align:right;font-family:'Syne',sans-serif;font-weight:600;color:#0d1117;font-size:12px"><?php echo e(number_format($p->montant_encaisse, 0, ',', ' ')); ?> F</td>
                                            <td style="padding:10px 18px;text-align:right;font-family:'Syne',sans-serif;font-weight:600;color:#8a6e2f;font-size:12px"><?php echo e(number_format($p->commission_ttc, 0, ',', ' ')); ?> F</td>
                                            <td style="padding:10px 18px;text-align:right;font-family:'Syne',sans-serif;font-weight:600;color:#16a34a;font-size:12px"><?php echo e(number_format($p->net_proprietaire, 0, ',', ' ')); ?> F</td>
                ...
                <tfoot>
                    <tr>
                        <td>TOTAL</td>
                        <td class="td-r"><?php echo e(number_format($kpiMois['total_loyers'], 0, ',', ' ')); ?> F</td>
                        <td class="td-r"><?php echo e(number_format($kpiMois['total_ttc'], 0, ',', ' ')); ?> F</td>
                        <td class="td-r" style="color:#16a34a"><?php echo e(number_format($kpiMois['total_net_proprio'], 0, ',', ' ')); ?> F</td>
                        <td class="td-c"><?php echo e($kpiMois['nb_paiements']); ?></td>
                        <td></td>
                    </tr>
                </tfoot>
            </table>
    ...
    <div class="card" style="margin-top:20px">
        <div class="card-hd">
            <div>
                ...
                <div style="font-size:11px;color:#9ca3af;margin-top:2px"><?php echo e($paiementsMois->total()); ?> paiement(s) · Page <?php echo e($paiementsMois->currentPage()); ?> / <?php echo e($paiementsMois->lastPage()); ?></div>
            </div>
        </div>
        <div style="overflow-x:auto">
            <table class="dt">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $paiementsMois; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td><span class="ref-tag"><?php echo e($p->reference_paiement); ?></span></td>
                        ...
                        <td>
                            ...
                            <div style="font-size:11px;color:#6b7280"><?php echo e($p->contrat->bien->ville); ?></div>
                        </td>
                        <td style="font-size:12px;color:#374151"><?php echo e($p->contrat->locataire->name); ?></td>
                        <td style="font-size:12px;color:#374151"><?php echo e($p->contrat->bien->proprietaire->name); ?></td>
                        <td style="font-size:12px;color:#6b7280"><?php echo e(\App\Models\Paiement::MODES_PAIEMENT[$p->mode_paiement] ?? $p->mode_paiement); ?></td>
                        <td class="td-r"><span class="amt-main"><?php echo e(number_format($p->montant_encaisse, 0, ',', ' ')); ?> F</span></td>
                        <td class="td-r"><span class="amt-gold"><?php echo e(number_format($p->commission_agence, 0, ',', ' ')); ?> F</span></td>
                        <td class="td-r"><span class="amt-red"><?php echo e(number_format($p->tva_commission, 0, ',', ' ')); ?> F</span></td>
                        <td class="td-r"><span class="amt-green"><?php echo e(number_format($p->net_proprietaire, 0, ',', ' ')); ?> F</span></td>
                        <td class="td-c">
                            <a href="<?php echo e(route('admin.paiements.pdf', $p)); ?>" target="_blank"
                    ...
                    <tr>
                        <td colspan="11" style="text-align:center;padding:40px;color:#9ca3af;font-size:13px">
                            Aucun paiement enregistré pour <?php echo e($debutMois->translatedFormat('F Y')); ?>
                ...
                <tfoot>
                    <tr>
                        ...
                        <td class="td-r"><?php echo e(number_format($kpiMois['total_loyers'], 0, ',', ' ')); ?> F</td>
                        <td class="td-r"><?php echo e(number_format($kpiMois['total_commission'], 0, ',', ' ')); ?> F</td>
                        <td class="td-r"><?php echo e(number_format($kpiMois['total_tva'], 0, ',', ' ')); ?> F</td>
                        <td class="td-r" style="color:#16a34a"><?php echo e(number_format($kpiMois['total_net_proprio'], 0, ',', ' ')); ?> F</td>
                        <td></td>
                    </tr>
                </tfoot>
        ...
        <div class="pagination-wrap">
            <div class="pagination-info">
                Affichage de <?php echo e($paiementsMois->firstItem()); ?> à <?php echo e($paiementsMois->lastItem()); ?> sur <?php echo e($paiementsMois->total()); ?> paiements
            </div>
            <div class="pagination-links">
                ...
                <?php else: ?>
                    <a href="<?php echo e($paiementsMois->previousPageUrl()); ?>" class="page-btn"><svg style="width:14px;height:14px" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="15 18 9 12 15 6"/></svg></a>
                <?php endif; ?>
                <?php $__currentLoopData = $paiementsMois->getUrlRange(max(1,$paiementsMois->currentPage()-2), min($paiementsMois->lastPage(),$paiementsMois->currentPage()+2)); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e($url); ?>" class="page-btn <?php echo e($page === $paiementsMois->currentPage() ? 'active':''); ?>"><?php echo e($page); ?></a>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php if($paiementsMois->hasMorePages()): ?>
                    <a href="<?php echo e($paiementsMois->nextPageUrl()); ?>" class="page-btn"><svg style="width:14px;height:14px" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="9 18 15 12 9 6"/></svg></a>
                <?php else: ?>
...
new Chart(ctx1, {
    type:'line',
    data:{
        labels: <?php echo json_encode($evolution->pluck('mois_label'), 15, 512) ?>,
        datasets:[
            {
                label:'Loyers',
                data: <?php echo json_encode($evolution->pluck('loyers'), 15, 512) ?>,
            ...
            },
            {
                ...
                data: <?php echo json_encode($evolution->pluck('ttc'), 15, 512) ?>,
...
new Chart(document.getElementById('chartRepartition'), {
    ...
    data:{
        ...
        datasets:[{
            data:[
                <?php echo e($kpiMois['total_net_proprio']); ?>,
                <?php echo e($kpiMois['total_commission']); ?>,
                <?php echo e($kpiMois['total_tva']); ?>
