...
<div class="card">
    ...
    <p class="sub-title">
        ...
        <strong><?php echo e($agency->name); ?></strong>. Bienvenue !
    </p>

    <?php if($agency->subscription && $agency->subscription->estActif()): ?>
    <div class="details-card">
        ...
        <div class="details-row">
            ...
            <span class="details-value"><?php echo e(\App\Models\Subscription::LABELS[$agency->subscription->plan] ?? $agency->subscription->plan); ?></span>
        </div>
        <div class="details-row">
            <span class="details-label">Expire le</span>
            <span class="details-value"><?php echo e($agency->subscription->date_fin_abonnement->format('d/m/Y')); ?></span>
        </div>
        <div class="details-row">
            <span class="details-label">Jours restants</span>
            <span class="details-value green"><?php echo e($agency->subscription->joursRestantsAbonnement()); ?> jours</span>
        </div>
    </div>
    <?php endif; ?>
    ...
    <p class="footer-note">
        Un email de confirmation a été envoyé à <?php echo e($agency->email ?? auth()->user()->email); ?>.<br>
        Questions ? <strong style="color:#8b949e">support@bimotech.sn</strong>
    </p>
</div>
</body>
</html>
<?php /**PATH C:\Users\ph\bimotech-immo\resources\views/subscription/succes.blade.php ENDPATH**/ ?>