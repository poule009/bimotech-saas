...
<head>
    ...
    <title>Paiement réussi — <?php echo e($agency->name); ?></title>
    ...
    <div class="max-w-md w-full mx-auto px-4">
        <div class="bg-white rounded-2xl shadow-lg border border-gray-200 p-10 text-center">
            ...
            <p class="text-gray-500 mb-6">
                ...
                <strong class="text-gray-800"><?php echo e($agency->name); ?></strong>.
            </p>
                    ...
                    <div class="text-sm text-gray-600 space-y-1">
                        <div class="flex justify-between">
                            ...
                            <span class="font-medium">
                                <?php echo e(\App\Models\Subscription::LABELS[$agency->subscription->plan] ?? $agency->subscription->plan); ?>
                        ...
                        <div class="flex justify-between">
                            ...
                            <span class="font-medium">
                                <?php echo e($agency->subscription->date_fin_abonnement->format('d/m/Y')); ?>
                        ...
                        <div class="flex justify-between">
                            ...
                            <span class="font-medium text-green-700">
                                <?php echo e($agency->subscription->joursRestantsAbonnement()); ?> jours
                            </span>
                        </div>
                    </div>
                </div>
            ...
            <p class="text-xs text-gray-400 mt-4">
                Un email de confirmation vous a été envoyé à <?php echo e($agency->email); ?>.
            </p>
