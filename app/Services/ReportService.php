...
{
    /**
     * Données agrégées du rapport financier mensuel d'une agence
     * (KPIs, évolution, répartition par propriétaire, impayés, stats générales).
     */
    public function generateFinancialReport(int $agencyId, int $annee, int $mois): array
    {
