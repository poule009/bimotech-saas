<x-app-layout>
    ...
    <div class="flex-between section-gap">
        <div>
            ...
            <p style="font-size:13px;color:var(--text-3);margin-top:3px;">{{ $locataires->total() }} locataire(s) enregistré(s)</p>
        </div>
        <a href="{{ route('admin.users.create', 'locataire') }}" class="btn btn-primary">
    ...
    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:10px;" class="section-gap">
        <div class="kpi" style="text-align:center;padding:16px;">
            <div class="kpi-value" style="color:#7c3aed;">{{ $stats['total'] }}</div>
        ...
        <div class="kpi" style="text-align:center;padding:16px;border-color:#bbf7d0;background:#f0fdf4;">
            <div class="kpi-value" style="color:#16a34a;">{{ $stats['actifs'] }}</div>
        ...
        <div class="kpi" style="text-align:center;padding:16px;border-color:#fde68a;background:#fffbeb;">
            <div class="kpi-value" style="color:#d97706;">{{ $stats['sans_contrat'] }}</div>
    ...
    <div class="mobile-cards section-gap">
        @forelse($locataires as $user)
            @php $contratActif = $user->contrats->firstWhere('statut', 'actif'); @endphp
            <div class="mobile-card">
                ...
                <div class="mobile-card-row">
                    ...
                    <span class="mobile-card-value">
                        ...
                        @endphp
                        @if($telBrutL)
                            <a href="tel:{{ $telBrutL }}" style="color:var(--agency);font-weight:600;text-decoration:none;">
                                📞 {{ $telBrutL }}
                            </a>
                            @if($waLinkL)
                                <a href="{{ $waLinkL }}" target="_blank"
        ...
        @empty
            <div style="text-align:center;padding:48px;color:var(--text-3);">
                ...
                <a href="{{ route('admin.users.create', 'locataire') }}" class="btn btn-primary btn-sm">
                ...
                <tbody>
                    @forelse($locataires as $user)
                        ...
                        <tr>
                            ...
                            <td style="color:var(--text-2);font-size:13px;">{{ $user->locataire?->profession ?? '—' }}</td>
