            ...
            <div class="px-5 py-4" data-status="{{ $aContrat ? 'actif' : 'sans' }}" data-search="{{ strtolower($user->name . ' ' . $user->email . ' ' . $user->telephone) }}">
                ...
                <div class="flex items-center justify-end gap-1.5">
                    ...
                    <a href="{{ $waLink }}" target="_blank"
                       class="w-7 h-7 flex items-center justify-center border border-bimo-navy/10 rounded-[6px] text-bimo-text/40 hover:border-[#25D366] hover:text-[#25D366] transition-all duration-150">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center gap-2 mt-0.5">
                                        @if($estEntreprise)
                                        <span class="inline-flex items-center px-1.5 py-0.5 rounded-[4px] text-[9px] font-body font-bold bg-bimo-navy/10 text-bimo-text/60">🏢 Entreprise</span>
                                        @endif
