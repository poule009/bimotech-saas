...
<div class="flex items-center gap-2 font-body text-sm text-bimo-navy/40 mb-5">
    ...
    <a href="{{ route('admin.users.show', $user) }}" class="hover:text-bimo-navy transition-colors duration-150">{{ $user->name }}</a>
    <svg class="w-3 h-3" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="9 18 15 12 9 6"/></svg>
...
<div class="flex items-center justify-between gap-3 flex-wrap mb-5">
    <div>
        <h1 class="font-display font-extrabold text-xl md:text-2xl text-bimo-navy tracking-tight">Modifier le profil</h1>
        <p class="font-body text-sm text-bimo-navy/50 mt-1">{{ $user->name }} · {{ $user->email }}</p>
    </div>
    <span class="inline-flex items-center px-3 py-1.5 rounded-[7px] border font-body font-semibold text-xs
                 {{ $user->isProprietaire() ? 'bg-bimo-gold/10 border-bimo-gold/25 text-bimo-gold' : 'bg-bimo-navy/10 border-bimo-navy/15 text-bimo-navy/70' }}">
    ...
    <div class="space-y-4">
        ...
        <div class="bg-white rounded-[14px] border border-bimo-navy/10 overflow-hidden">
            <div class="flex items-center gap-3 px-5 py-4 border-b border-bimo-navy/[5%] bg-bimo-bg2">
                <div class="w-8 h-8 rounded-[8px] bg-bimo-navy/10 flex items-center justify-center flex-shrink-0">
                    <svg class="w-4 h-4 text-bimo-navy/50" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/></svg>
                </div>
                <span class="font-display font-bold text-sm text-bimo-navy">Profil propriétaire</span>
            </div>
            <div class="px-5 py-5 space-y-4">
                <div class="grid grid-cols-2 gap-3">
                    <div class="space-y-1.5">
                        <label class="block font-body font-medium text-sm text-bimo-navy">CNI / Passeport</label>
        ...
        <div class="bg-white rounded-[14px] border border-bimo-navy/10 overflow-hidden">
            <div class="flex items-center gap-3 px-5 py-4 border-b border-bimo-navy/[5%] bg-bimo-bg2">
                ...
                <span class="font-display font-bold text-sm text-bimo-navy">Coordonnées bancaires</span>
            </div>
            <div class="px-5 py-5 space-y-4">
                <div class="space-y-1.5">
                    <label class="block font-body font-medium text-sm text-bimo-navy">Mode de paiement préféré</label>
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div class="space-y-1.5">
                        <label class="block font-body font-medium text-sm text-bimo-navy">Banque</label>
                ...
                <div class="space-y-1.5">
                    ...
                    <input type="text" name="numero_om" value="{{ old('numero_om', $user->proprietaire?->numero_om) }}" placeholder="+221 7X XXX XX XX"
                           class="w-full max-w-xs px-4 py-3 rounded-[10px] bg-white border border-bimo-navy/20 font-body text-sm text-bimo-navy
                                  placeholder:text-bimo-navy/30 focus:outline-none focus:border-bimo-gold focus:ring-2 focus:ring-bimo-gold/15 transition-all duration-150">
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-[14px] border border-bimo-navy/10 overflow-hidden">
            <div class="flex items-center gap-3 px-5 py-4 border-b border-bimo-navy/[5%] bg-bimo-bg2">
                ...
                <span class="font-display font-bold text-sm text-bimo-navy">Profil locataire</span>
            </div>
            <div class="px-5 py-5 space-y-4">
                <div class="grid grid-cols-2 gap-3">
                    <div class="space-y-1.5">
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div class="space-y-1.5">
                        <label class="block font-body font-medium text-sm text-bimo-navy">Revenu mensuel (FCFA)</label>
        ...
        <div class="bg-white rounded-[14px] border border-bimo-navy/10 overflow-hidden">
            ...
            <div class="px-5 py-5 space-y-4">
                ...
                <div class="space-y-1.5">
                    <label class="block font-body font-medium text-sm text-bimo-navy">Lien de parenté</label>
        ...
        <div class="bg-white rounded-[14px] border border-bimo-navy/10 overflow-hidden">
            <div class="flex items-center gap-3 px-5 py-4 border-b border-bimo-navy/[5%] bg-bimo-bg2">
                ...
                <span class="font-display font-bold text-sm text-bimo-navy">Statut fiscal</span>
            </div>
            <div class="px-5 py-5">
