                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <div class="space-y-1.5">
                            ...
                            <div class="h-1 rounded-full bg-bimo-navy/10 mt-2 overflow-hidden">
                                <div id="pwd-bar" class="h-full rounded-full transition-all duration-300" style="width:0%;background:#E11428"></div>
                            </div>
...
function checkPwd(v) {
    ...
    const levels = [
        { pct:'25%', color:'#E11428', label:'Trop faible' },
...
function checkConfirm() {
    ...
    else { hint.textContent='✗ Ne correspondent pas'; hint.style.color='#E11428'; }
}
