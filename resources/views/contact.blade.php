...
<div class="max-w-[1000px] mx-auto px-[5%] pb-24 grid grid-cols-1 md:grid-cols-[1fr_1.4fr] gap-12 items-start">
    ...
    <div class="flex flex-col gap-5">
        ...
        <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', config('services.bimotech.whatsapp', '221XXXXXXXXX')) }}?text={{ rawurlencode('Bonjour bee, je souhaite en savoir plus sur votre solution.') }}" target="_blank"
