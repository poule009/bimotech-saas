...
<body style="font-family: sans-serif; color: #333; max-width: 600px; margin: 0 auto; padding: 24px;">
    ...
    <h2 style="color: #1a56db;">Nouveau message de contact</h2>
    ...
    <table style="width: 100%; border-collapse: collapse; margin-top: 16px;">
        ...
        <tr style="background:#f9f9f9"><td style="padding: 8px; font-weight: bold;">Objet</td><td style="padding: 8px;">{{ ucfirst($data['objet']) }}</td></tr>
    </table>

    <div style="margin-top: 16px; padding: 16px; background: #f4f4f4; border-left: 4px solid #1a56db; border-radius: 4px;">
        <strong>Message :</strong>
        <p style="margin-top: 8px; white-space: pre-line;">{{ $data['message'] }}</p>
    </div>
