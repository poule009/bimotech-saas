...
<div class="max-w-[720px] mx-auto px-[5%] pt-[120px] pb-24">
    ...
    <p class="font-body text-sm text-bimo-text/60 leading-[1.8] mb-3">Pour exercer ces droits : <a href="mailto:contact@bimotech.sn" class="text-bimo-gold no-underline hover:underline">contact@bimotech.sn</a></p>
