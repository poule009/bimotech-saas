...
<div class="max-w-[720px] mx-auto px-[5%] pt-[120px] pb-24">
    ...
    <h1 class="font-display font-extrabold text-[clamp(26px,4vw,40px)] tracking-tight text-bimo-navy mb-2">Politique de confidentialité</h1>
    ...
    <h2 class="font-display font-bold text-[17px] text-bimo-navy mt-10 mb-3 pb-2 border-b border-bimo-navy/10">2. Données collectées</h2>
    <h3 class="font-body font-semibold text-sm text-bimo-navy mt-5 mb-2">Lors de la création de compte</h3>
    <ul class="space-y-1 mb-4">@foreach(['Nom et prénom de l\'administrateur','Adresse email professionnelle','Mot de passe (chiffré, jamais stocké en clair)','Nom et NINEA de l\'agence','Numéro de téléphone de l\'agence'] as $item)<li class="font-body text-sm text-bimo-navy/60 pl-4 relative before:absolute before:left-0 before:text-bimo-gold before:content-['·']">{{ $item }}</li>@endforeach</ul>
    <h3 class="font-body font-semibold text-sm text-bimo-navy mt-5 mb-2">Dans le cadre de l'utilisation du service</h3>
    <ul class="space-y-1 mb-4">@foreach(['Informations sur les biens immobiliers gérés','Données des propriétaires et locataires','Contrats de bail et documents associés','Historique des paiements de loyer','Logs d\'activité (actions réalisées, dates, adresses IP)'] as $item)<li class="font-body text-sm text-bimo-navy/60 pl-4 relative before:absolute before:left-0 before:text-bimo-gold before:content-['·']">{{ $item }}</li>@endforeach</ul>

    <h2 class="font-display font-bold text-[17px] text-bimo-navy mt-10 mb-3 pb-2 border-b border-bimo-navy/10">4. Base légale du traitement</h2>
    ...
    <p class="font-body text-sm text-bimo-navy/60 leading-[1.8] mb-3">Conformément à la loi sénégalaise n°2008-12 du 25 janvier 2008, vous disposez des droits suivants :</p>
    <ul class="space-y-1 mb-4">@foreach(['<strong class="text-bimo-navy font-medium">Droit d\'accès :</strong> obtenir une copie de vos données','<strong class="text-bimo-navy font-medium">Droit de rectification :</strong> corriger des données inexactes','<strong class="text-bimo-navy font-medium">Droit à l\'effacement :</strong> demander la suppression','<strong class="text-bimo-navy font-medium">Droit à la portabilité :</strong> exporter vos données','<strong class="text-bimo-navy font-medium">Droit d\'opposition :</strong> vous opposer à certains traitements'] as $item)<li class="font-body text-sm text-bimo-navy/60 pl-4 relative before:absolute before:left-0 before:text-bimo-gold before:content-['·']">{!! $item !!}</li>@endforeach</ul>
    <p class="font-body text-sm text-bimo-navy/60 leading-[1.8] mb-3">Pour exercer ces droits : <a href="mailto:contact@bimotech.sn" class="text-bimo-gold no-underline hover:underline">contact@bimotech.sn</a></p>
    <p class="font-body text-sm text-bimo-navy/60 leading-[1.8]">Réclamation possible auprès de la <strong class="text-bimo-navy font-medium">Commission de Protection des Données Personnelles (CDP)</strong> du Sénégal : <a href="https://www.cdp.sn" target="_blank" class="text-bimo-gold no-underline hover:underline">www.cdp.sn</a></p>
