...
<div class="max-w-[720px] mx-auto px-[5%] pt-[120px] pb-24">
    ...
    <div class="bg-marketing-gold/[6%] border border-marketing-gold/20 rounded-[12px] px-6 py-5 mb-8">
        <p class="font-body text-sm text-marketing-gold/80 leading-relaxed">BimoTech Immo s'engage à protéger vos données personnelles. Nous ne vendons jamais vos données à des tiers et nous ne faisons aucune publicité ciblée.</p>
    </div>

    @foreach([
        ['1. Qui sommes-nous ?', ['BimoTech Immo est une plateforme SaaS de gestion immobilière destinée aux agences immobilières sénégalaises, éditée par BimoTech, dont le siège est à Dakar, Sénégal.', 'Pour toute question relative à vos données : <a href="mailto:contact@bimotech.sn" class="text-marketing-gold no-underline hover:underline">contact@bimotech.sn</a>']],
        ...
        ['11. Contact', ['Pour toute question : <a href="mailto:contact@bimotech.sn" class="text-marketing-gold no-underline hover:underline">contact@bimotech.sn</a> — BimoTech Immo, Dakar, Sénégal']],
    ] as [$h, $paras])
    ...
    <p class="font-body text-sm text-bimo-text/60 leading-[1.8] mb-3">BimoTech ne vend, ne loue et ne partage jamais vos données avec des tiers à des fins commerciales.</p>
