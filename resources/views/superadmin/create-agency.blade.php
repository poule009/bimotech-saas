...
<div class="max-w-2xl">
    ...
    <nav class="flex items-center gap-2 font-body text-sm text-bimo-navy/40 mb-5">
        ...
        <span class="text-bimo-navy font-semibold">Nouvelle agence</span>
    </nav>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div class="space-y-1.5">
                        ...
                        <input type="text" id="agency_name" name="agency_name" value="{{ old('agency_name') }}" required placeholder="Ex : Agence Immobilière Dakar"
                               class="w-full px-4 py-3 rounded-[10px] bg-white border font-body text-sm text-bimo-navy placeholder:text-bimo-navy/35 focus:outline-none focus:ring-2 transition-all duration-150 @error('agency_name') border-bimo-red focus:border-bimo-red focus:ring-bimo-red/15 @else border-bimo-navy/20 focus:border-bimo-gold focus:ring-bimo-gold/15 @enderror">
                        @error('agency_name')<p class="font-body text-xs text-bimo-red">{{ $message }}</p>@enderror
                    </div>
                    <div class="space-y-1.5">
                        <label class="block font-body font-medium text-sm text-bimo-navy" for="agency_email">Email de l'agence <span class="text-bimo-red">*</span></label>
                        <input type="email" id="agency_email" name="agency_email" value="{{ old('agency_email') }}" required placeholder="contact@agence.sn"
                               class="w-full px-4 py-3 rounded-[10px] bg-white border font-body text-sm text-bimo-navy placeholder:text-bimo-navy/35 focus:outline-none focus:ring-2 transition-all duration-150 @error('agency_email') border-bimo-red focus:border-bimo-red focus:ring-bimo-red/15 @else border-bimo-navy/20 focus:border-bimo-gold focus:ring-bimo-gold/15 @enderror">
                        @error('agency_email')<p class="font-body text-xs text-bimo-red">{{ $message }}</p>@enderror
                    </div>
                    <div class="space-y-1.5">
                        <label class="block font-body font-medium text-sm text-bimo-navy" for="agency_telephone">Téléphone <span class="font-light text-bimo-navy/40">(optionnel)</span></label>
                    ...
                    <div class="space-y-1.5">
                        <label class="block font-body font-medium text-sm text-bimo-navy" for="agency_adresse">Adresse <span class="font-light text-bimo-navy/40">(optionnel)</span></label>
        ...
        <div class="bg-white rounded-[14px] border border-bimo-navy/10 overflow-hidden">
            <div class="flex items-center gap-3 px-5 py-4 border-b border-bimo-navy/[5%] bg-bimo-bg2">
                <div class="w-8 h-8 rounded-[8px] bg-bimo-navy/10 flex items-center justify-center flex-shrink-0">
                    <svg class="w-4 h-4 text-bimo-navy/50" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
                </div>
                <span class="font-display font-bold text-sm text-bimo-navy">Compte administrateur de l'agence</span>
            </div>
            <div class="px-5 py-5">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div class="space-y-1.5">
                        <label class="block font-body font-medium text-sm text-bimo-navy" for="admin_name">Nom complet <span class="text-bimo-red">*</span></label>
                        <input type="text" id="admin_name" name="admin_name" value="{{ old('admin_name') }}" required placeholder="Prénom Nom"
                               class="w-full px-4 py-3 rounded-[10px] bg-white border font-body text-sm text-bimo-navy placeholder:text-bimo-navy/35 focus:outline-none focus:ring-2 transition-all duration-150 @error('admin_name') border-bimo-red focus:border-bimo-red focus:ring-bimo-red/15 @else border-bimo-navy/20 focus:border-bimo-gold focus:ring-bimo-gold/15 @enderror">
                        @error('admin_name')<p class="font-body text-xs text-bimo-red">{{ $message }}</p>@enderror
                    </div>
                    <div class="space-y-1.5">
                        <label class="block font-body font-medium text-sm text-bimo-navy" for="admin_email">Email de connexion <span class="text-bimo-red">*</span></label>
                        <input type="email" id="admin_email" name="admin_email" value="{{ old('admin_email') }}" required placeholder="admin@agence.sn"
                               class="w-full px-4 py-3 rounded-[10px] bg-white border font-body text-sm text-bimo-navy placeholder:text-bimo-navy/35 focus:outline-none focus:ring-2 transition-all duration-150 @error('admin_email') border-bimo-red focus:border-bimo-red focus:ring-bimo-red/15 @else border-bimo-navy/20 focus:border-bimo-gold focus:ring-bimo-gold/15 @enderror">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <input type="password" id="admin_password" name="admin_password" required placeholder="Minimum 8 caractères"
                               class="w-full px-4 py-3 rounded-[10px] bg-white border font-body text-sm text-bimo-navy placeholder:text-bimo-navy/35 focus:outline-none focus:ring-2 transition-all duration-150 @error('admin_password') border-bimo-red focus:border-bimo-red focus:ring-bimo-red/15 @else border-bimo-navy/20 focus:border-bimo-gold focus:ring-bimo-gold/15 @enderror">
                        <p class="font-body text-xs text-bimo-navy/40 mt-1">L'admin recevra ce mot de passe par email.</p>
                        @error('admin_password')<p class="font-body text-xs text-bimo-red">{{ $message }}</p>@enderror
                    </div>
                    <div class="space-y-1.5">
                        <label class="block font-body font-medium text-sm text-bimo-navy" for="admin_password_confirmation">Confirmer le mot de passe <span class="text-bimo-red">*</span></label>
                ...
                <div class="mt-4 flex items-start gap-2 bg-bimo-navy/[4%] border border-bimo-navy/10 rounded-[8px] px-4 py-3">
                    ...
                    <p class="font-body text-xs text-bimo-navy/50">Un email de bienvenue avec les identifiants sera envoyé. <strong>Vous resterez connecté en tant que Super Admin.</strong></p>
                </div>
            </div>
        </div>
