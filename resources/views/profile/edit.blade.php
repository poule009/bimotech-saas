...
<div class="max-w-2xl space-y-5">
    ...
    <div class="bg-white rounded-[14px] border border-bimo-navy/10 overflow-hidden">
        <div class="flex items-center gap-3 px-5 py-4 border-b border-bimo-navy/[5%] bg-bimo-bg2">
            ...
            <div>
                <div class="font-display font-bold text-sm text-bimo-text">Informations du profil</div>
                <div class="font-body text-xs text-bimo-text/40">Mettez à jour votre nom et votre adresse email.</div>
            </div>
        </div>
        <div class="px-5 py-5">
    ...
    <div class="bg-white rounded-[14px] border border-bimo-navy/10 overflow-hidden">
        <div class="flex items-center gap-3 px-5 py-4 border-b border-bimo-navy/[5%] bg-bimo-bg2">
            <div class="w-8 h-8 rounded-[8px] bg-bimo-navy/10 flex items-center justify-center flex-shrink-0">
                <svg class="w-4 h-4 text-bimo-text/50" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0110 0v4"/></svg>
            </div>
            <div>
            ...
            <div class="ml-auto flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-white border border-bimo-navy/10">
                ...
                <span class="font-body text-[10px] text-bimo-text/50">Google</span>
            </div>
            @endif
        </div>
        <div class="px-5 py-5">
            @if($user->google_id)
                ...
                <form method="post" action="{{ route('password.set') }}" class="space-y-4">
                    ...
                    <div class="space-y-1.5">
                        <label class="block font-body font-medium text-sm text-bimo-text" for="set_password">Nouveau mot de passe</label>
                    ...
                    <div class="space-y-1.5">
                        <label class="block font-body font-medium text-sm text-bimo-text" for="set_password_confirmation">Confirmer le mot de passe</label>
