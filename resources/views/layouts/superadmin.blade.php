...
@php
    ...
    $saNav = [
        ...
        ['label' => 'Abonnements & facturation',   'href' => route('superadmin.subscriptions'),              'active' => request()->routeIs('superadmin.subscriptions'), 'icon' => '<rect x="2" y="5" width="20" height="14" rx="2"/><path d="M2 10h20"/>'],
