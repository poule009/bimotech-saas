...
@php
    ...
    $saNav = [
        ...
        ['label' => 'Agences',                     'href' => route('superadmin.agencies.index'),             'active' => request()->routeIs('superadmin.agencies.*'),  'icon' => '<path d="M3 21h18M5 21V7l7-4 7 4v14M9 21v-6h6v6"/>'],
        ['label' => 'Abonnements & facturation',   'href' => route('superadmin.facturation'),                'active' => request()->routeIs('superadmin.facturation') || request()->routeIs('superadmin.plans.*'), 'icon' => '<rect x="2" y="5" width="20" height="14" rx="2"/><path d="M2 10h20"/>'],
        ['label' => 'Support / Debug',             'href' => route('superadmin.support'),                    'active' => request()->routeIs('superadmin.support'),     'icon' => '<path d="M12 2a10 10 0 100 20 10 10 0 000-20z"/><path d="M9.1 9a3 3 0 015.8 1c0 2-3 3-3 3"/><path d="M12 17h.01"/>'],
        ['label' => 'Règles fiscales',             'href' => route('superadmin.regles.index'),               'active' => request()->routeIs('superadmin.regles.*'), 'icon' => '<path d="M4 4h16v4H4V4Z"/><path d="M5 8v11a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V8"/><path d="M9 13h6M9 17h6"/>'],
