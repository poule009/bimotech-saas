...
<head>
    ...
    {{-- Injection dynamique de couleur --}}
        ...
        <div class="sidebar-logo">
            @if (isset($currentAgency))
                @if ($currentAgency?->logo_path)
                    <img src="{{ Storage::url($currentAgency->logo_path) }}" alt="{{ $currentAgency->name }}" style="height:35px; width:auto; filter: brightness(0) invert(1);">
                @else
            ...
            <div style="position:relative;">
                ...
                <div class="dropdown" id="dropdown">
                    <div style="padding: 16px; border-bottom: 1px solid rgba(255,255,255,0.1)">
                        ...
                        <p style="color:#fff; font-size:13px; font-weight:600">{{ auth()->user()->email }}</p>
                    </div>
