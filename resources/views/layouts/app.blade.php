...
<aside id="sidebar"
    ...
    <nav class="flex-1 px-3 py-4 space-y-0.5 overflow-y-auto">
        ...
        <a href="{{ route('admin.comptabilite.index') }}" onclick="closeSidebar()"
           class="flex items-center gap-3 px-3 py-2 rounded-[10px] transition-all duration-150
                  {{ str_starts_with($route, 'admin.comptabilite') || str_starts_with($route, 'admin.reversements') || str_starts_with($route, 'admin.charges-agence') || str_starts_with($route, 'admin.tresorerie') || str_starts_with($route, 'admin.rapports') ? 'bg-white/15 text-white' : 'text-white hover:bg-white/10' }}">
