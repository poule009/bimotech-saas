...
<meta name="description" content="bee — Logiciel de gestion immobilière pour agences au Sénégal. Biens, contrats, loyers, quittances conformes TVA 18%, BRS, DGID. Essai gratuit 30 jours.">
...
<title>bee — Gestion immobilière Sénégal</title>
<meta property="og:type" content="website">
<meta property="og:url" content="https://immo.bimotechsn.com/">
<meta property="og:title" content="bee — Gestion immobilière professionnelle au Sénégal">
...
<meta name="twitter:title" content="bee — Logiciel gestion immobilière Sénégal">
...
<section class="min-h-screen flex items-center justify-center flex-col text-center px-[5%] pt-[100px] pb-20 bg-white">
    <div class="relative z-10 max-w-[820px] w-full">
        ...
        <div class="inline-flex items-center gap-2 bg-marketing-gold/10 border border-marketing-gold/20 rounded-full px-4 py-1.5 font-body font-medium text-xs text-marketing-gold mb-8 fade-up">
            <div class="w-[7px] h-[7px] bg-marketing-gold rounded-full pulse flex-shrink-0"></div>
        ...
        <h1 class="font-display font-extrabold text-[clamp(38px,6.5vw,76px)] leading-[1.04] tracking-[-2.5px] text-bimo-text mb-6 fade-up" style="animation-delay:.08s">
            Gérez votre agence<br>immobilière, <em class="not-italic text-marketing-gold">l'esprit<br>tranquille</em>
        </h1>
        ...
        <div class="flex items-center justify-center gap-3 flex-wrap mb-6 fade-up" style="animation-delay:.24s">
            <a href="{{ route('agency.register') }}" class="inline-flex items-center gap-1.5 font-body font-bold text-sm text-bimo-text no-underline px-7 py-3.5 rounded-[10px] bg-marketing-gold hover:opacity-90 hover:-translate-y-0.5 transition-all duration-150 shadow-md">
                Créer mon agence gratuitement
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg>
            </a>
            <a href="{{ route('demo') }}" class="inline-flex items-center gap-1.5 font-body font-medium text-sm text-bimo-text no-underline px-7 py-3.5 rounded-[10px] bg-white border border-bimo-navy/15 hover:border-marketing-gold hover:text-marketing-gold hover:-translate-y-0.5 transition-all duration-150 shadow-sm">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polygon points="5 3 19 12 5 21 5 3"/></svg>
                Demander une démo
            </a>
        </div>
        <p class="font-body text-xs text-bimo-text/40 fade-up" style="animation-delay:.32s">30 jours d'essai gratuit · <span class="text-marketing-gold">Aucune carte bancaire requise</span> · Accès immédiat</p>
            ...
            <div class="bg-bimo-navy rounded-[16px] overflow-hidden shadow-2xl">
                ...
                <div class="bg-bimo-navy-dk px-4 py-3 flex items-center gap-2.5 border-b border-white/[8%]">
                    <div class="flex gap-1.5">
                        ...
                        <div class="w-[11px] h-[11px] rounded-full bg-marketing-gold/60"></div>
                    ...
                    <div class="flex-1 mx-3 bg-white/10 border border-white/[8%] rounded-[6px] px-3 py-1.5 flex items-center gap-1.5">
                        <span class="text-marketing-gold opacity-60"><svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0110 0v4"/></svg></span>
                ...
                <div class="grid md:grid-cols-[190px_1fr] min-h-[340px]">
                    ...
                    <div class="hidden md:flex flex-col gap-0.5 bg-bimo-navy-dk border-r border-white/[8%] p-3">
                        <div class="flex items-center gap-1.5 font-display font-extrabold text-sm text-marketing-gold px-2 py-1 mb-4">
                            <div class="w-2 h-2 bg-marketing-gold rounded-[2px]"></div>bee
                        </div>
                        ...
                        <div class="flex items-center gap-2 px-2.5 py-2 rounded-[7px] font-body text-[11.5px] {{ $a === 'active' ? 'bg-marketing-gold/10 text-marketing-gold font-semibold' : 'text-white/40' }}">
                    ...
                    <div class="bg-bimo-navy p-5 flex flex-col gap-3.5">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-2.5">
                            @foreach([['border-marketing-gold','text-marketing-gold','Loyers encaissés','3,2M','FCFA ce mois'],['border-white/20','text-white','Biens occupés','18/20','90% d\'occupation'],['border-bimo-red/60','text-bimo-red','Impayés','2','Relances envoyées'],['border-marketing-gold/40','text-marketing-gold','Net propriétaires','2,7M','Après commission']] as [$bc,$vc,$lbl,$val,$sub])
                        ...
                        <div class="hidden md:block bg-bimo-navy-dk border border-white/[8%] rounded-[10px] overflow-hidden">
                            ...
                            @foreach([['A. Diallo','Villa Fann','350 000','Wave','Payé','bg-marketing-gold/10 border-marketing-gold/20 text-marketing-gold'],['M. Ndiaye','Appt Plateau','280 000','Virement','Attente','bg-bimo-navy-dk/80 text-white/40'],['F. Sow','Bureau Almadies','520 000','Chèque','Payé','bg-marketing-gold/10 border-marketing-gold/20 text-marketing-gold'],['I. Ba','Studio Mermoz','185 000','OM','Retard','bg-bimo-red/10 border-bimo-red/20 text-bimo-red']] as [$n,$b,$m,$md,$st,$sc])
...
<div class="px-[5%] py-10 border-t border-b border-bimo-navy/10 bg-bimo-bg2">
    <div class="max-w-[1000px] mx-auto flex flex-wrap items-center justify-center gap-10">
        <div class="font-body font-semibold text-[11px] text-bimo-text/40 uppercase tracking-[1.5px] whitespace-nowrap">Pourquoi bee</div>
        ...
        <div class="flex flex-wrap items-center justify-center gap-8 md:gap-12">
            ...
            <div class="text-center">
                <div class="font-display font-extrabold text-marketing-gold leading-none" style="font-size:{{ $fs }}px;letter-spacing:-.3px">{{ $n }}</div>
    ...
    <div class="max-w-[860px] mx-auto">
        <div class="text-center mb-10">
            <div class="inline-flex items-center gap-1.5 font-body font-semibold text-[11px] text-marketing-gold uppercase tracking-[2px] mb-4">
                <span class="w-4 h-px bg-marketing-gold inline-block"></span>Démonstration
            </div>
            <h2 class="font-display font-extrabold text-[clamp(1.6rem,3vw,2.2rem)] tracking-tight text-bimo-text mb-3">La gestion locative <em class="not-italic text-marketing-gold">automatisée</em></h2>
        ...
        <div class="rounded-[18px] overflow-hidden border border-bimo-navy/10 shadow-xl bg-bimo-navy mt-10">
            ...
            <div class="flex flex-col items-center justify-center py-20 px-8 gap-6">
                <div class="w-[72px] h-[72px] rounded-full bg-marketing-gold/10 border border-marketing-gold/30 flex items-center justify-center">
                ...
                <div class="text-center">
                    ...
                    <div class="font-body text-sm text-white/40">Obtenez une démonstration personnalisée avec un expert bee</div>
                </div>
                <a href="{{ route('demo') }}" class="inline-flex items-center gap-2 px-6 py-3 bg-marketing-gold/10 border border-marketing-gold/20 rounded-[10px] text-marketing-gold font-body font-semibold text-sm no-underline hover:bg-marketing-gold/20 transition-colors duration-150">
...
<section class="px-[5%] py-24 bg-bimo-bg" id="fonctionnalites">
    <div class="max-w-[1040px] mx-auto">
        <div class="mb-14">
            <div class="inline-flex items-center gap-1.5 font-body font-semibold text-[11px] text-marketing-gold uppercase tracking-[2px] mb-4">
                <span class="w-4 h-px bg-marketing-gold inline-block"></span>Fonctionnalités
            </div>
            <h2 class="font-display font-extrabold text-[clamp(28px,4vw,46px)] tracking-tight leading-[1.08] text-bimo-text mb-4">Tout ce dont votre agence<br>a besoin, <em class="not-italic text-marketing-gold">rien de superflu</em></h2>
            <p class="font-body text-base text-bimo-text/50 max-w-[540px] leading-relaxed">bee n'est pas un annuaire immobilier. C'est un outil de gestion professionnelle pour les agences qui veulent structurer leur activité.</p>
        </div>
...
<div class="px-[5%] py-24 bg-bimo-bg2 border-t border-b border-bimo-navy/10">
    <div class="max-w-[1040px] mx-auto">
        <div class="mb-14">
            ...
            <h2 class="font-display font-extrabold text-[clamp(28px,4vw,46px)] tracking-tight leading-[1.08] text-bimo-text">Ce que bee change<br>pour votre <em class="not-italic text-marketing-gold">agence</em></h2>
        </div>
...
<section class="px-[5%] py-24 bg-white" id="conformite">
    <div class="max-w-[1040px] mx-auto">
        <div class="mb-14">
            <div class="inline-flex items-center gap-1.5 font-body font-semibold text-[11px] text-marketing-gold uppercase tracking-[2px] mb-4">
                <span class="w-4 h-px bg-marketing-gold inline-block"></span>Conformité fiscale
            </div>
            <h2 class="font-display font-extrabold text-[clamp(28px,4vw,46px)] tracking-tight leading-[1.08] text-bimo-text mb-4">Le seul SaaS immobilier<br><em class="not-italic text-marketing-gold">conforme au droit sénégalais</em></h2>
            <p class="font-body text-base text-bimo-text/50 max-w-[540px] leading-relaxed">bee intègre nativement les obligations fiscales et légales du Sénégal. Pas de modules à activer, pas de configuration complexe.</p>
        </div>
        <div class="bg-bimo-bg border border-bimo-navy/10 rounded-[20px] p-12">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-7">
                ...
                <div class="flex items-start gap-3.5">
                    <div class="w-6 h-6 bg-marketing-gold/10 border border-bimo-navy/10 rounded-[7px] flex items-center justify-center flex-shrink-0 mt-0.5">
...
<section class="px-[5%] py-24 bg-bimo-navy border-t border-b border-bimo-navy/20">
    <div class="max-w-[1040px] mx-auto">
        <div class="mb-14">
            <div class="inline-flex items-center gap-1.5 font-body font-semibold text-[11px] text-marketing-gold uppercase tracking-[2px] mb-4">
                <span class="w-4 h-px bg-marketing-gold inline-block"></span>Démarrage rapide
            </div>
            <h2 class="font-display font-extrabold text-[clamp(28px,4vw,46px)] tracking-tight leading-[1.08] text-white">Opérationnel en <em class="not-italic text-marketing-gold">moins de 10 minutes</em></h2>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
            <div class="hidden md:block absolute top-[27px] left-[calc(16.7%+12px)] right-[calc(16.7%+12px)] h-px bg-marketing-gold/30 z-0"></div>
            ...
            <div class="text-center relative z-10">
                <div class="w-[54px] h-[54px] bg-marketing-gold rounded-full flex items-center justify-center font-display font-extrabold text-lg text-bimo-text mx-auto mb-5 shadow-lg">{{ $num }}</div>
...
<section class="px-[5%] py-24 bg-bimo-bg2 border-t border-bimo-navy/10" id="tarifs">
    <div class="max-w-[1040px] mx-auto">
        <div class="text-center mb-10">
            <div class="inline-flex items-center justify-center gap-1.5 font-body font-semibold text-[11px] text-marketing-gold uppercase tracking-[2px] mb-4">
                <span class="w-4 h-px bg-marketing-gold inline-block"></span>Tarifs
            </div>
            <h2 class="font-display font-extrabold text-[clamp(28px,4vw,46px)] tracking-tight leading-[1.08] text-bimo-text mb-3">Starter, Pro ou Agence —<br><em class="not-italic text-marketing-gold">30 jours d'essai gratuit</em></h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-5 max-w-[840px] mx-auto mb-8">
            ...
            <div class="rounded-[14px] p-8 flex flex-col relative transition-all duration-200 hover:-translate-y-1 {{ $featured ? 'bg-bimo-navy border border-bimo-navy shadow-xl pt-11' : 'bg-white border border-bimo-navy/10 hover:shadow-md hover:border-bimo-navy/20' }}">
                ...
                <a href="{{ route('agency.register') }}"
                   class="block text-center py-3 rounded-[10px] font-display font-bold text-sm no-underline transition-all duration-150 {{ $featured ? 'bg-marketing-gold text-bimo-text hover:opacity-90' : 'border border-bimo-navy/15 text-bimo-text hover:border-marketing-gold hover:text-marketing-gold' }}">
...
<div class="px-[5%] py-28 text-center bg-bimo-navy">
    <div class="relative z-10 max-w-[600px] mx-auto">
        <div class="inline-flex items-center justify-center gap-1.5 font-body font-semibold text-[11px] text-marketing-gold uppercase tracking-[2px] mb-6">
            <span class="w-4 h-px bg-marketing-gold inline-block"></span>Prêt à vous lancer ?
        </div>
        <h2 class="font-display font-extrabold text-[clamp(28px,4vw,46px)] tracking-tight leading-[1.08] text-white mb-4">Rejoignez les agences qui<br>gèrent mieux avec <em class="not-italic text-marketing-gold">bee</em></h2>
        ...
        <div class="flex items-center justify-center gap-3 flex-wrap mb-6">
            <a href="{{ route('agency.register') }}" class="inline-flex items-center gap-1.5 font-display font-bold text-sm text-bimo-text no-underline px-7 py-3.5 rounded-[10px] bg-marketing-gold hover:opacity-90 hover:-translate-y-0.5 transition-all duration-150">
                Créer mon agence gratuitement →
            </a>
        ...
        <div class="flex flex-wrap items-center justify-center gap-4 md:gap-6 font-body text-xs text-white/30">
            ...
            <span class="flex items-center gap-1.5"><span class="w-1 h-1 rounded-full bg-marketing-gold inline-block flex-shrink-0"></span>{{ $item }}</span>
            @endforeach
        </div>
    </div>
</div>
...
<footer class="bg-bimo-navy-dk border-t border-white/[8%] px-[5%] pt-14 pb-8">
    <div class="max-w-[1040px] mx-auto">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[1.5fr_1fr_1fr_1fr] gap-12 pb-12 border-b border-white/[8%]">
            <div>
                ...
                <div class="flex gap-2.5 mt-5">
                    <a href="https://wa.me/{{ preg_replace('/[^0-9]/','',config('services.bimotech.whatsapp')) }}" target="_blank" rel="noopener"
        ...
        <div class="flex flex-col md:flex-row items-center justify-between gap-4 mt-8">
            <div class="font-body text-xs text-white/30">© {{ date('Y') }} bee · Dakar, Sénégal · support@bimotech.sn</div>
...
@php
$schemaOrg = json_encode(['@context'=>'https://schema.org','@graph'=>[['@type'=>'SoftwareApplication','name'=>'bee','url'=>'https://immo.bimotechsn.com','description'=>'Logiciel de gestion immobilière pour agences au Sénégal. Conforme TVA 18%, BRS et CGI SN.','applicationCategory'=>'BusinessApplication','operatingSystem'=>'Web','offers'=>['@type'=>'Offer','price'=>'0','priceCurrency'=>'XOF']],['@type'=>'Organization','name'=>'bee','url'=>'https://immo.bimotechsn.com','address'=>['@type'=>'PostalAddress','addressLocality'=>'Dakar','addressCountry'=>'SN']]]], JSON_UNESCAPED_UNICODE|JSON_UNESCAPED_SLASHES);
@endphp
<script type="application/ld+json">{!! $schemaOrg !!}</script>

{{-- Bouton WhatsApp flottant — exception palette documentée (#25D366) --}}
<a href="https://wa.me/{{ preg_replace('/[^0-9]/','',config('services.bimotech.whatsapp')) }}?text=Bonjour%2C%20je%20voudrais%20une%20d%C3%A9mo%20de%20bee%20Immo"
