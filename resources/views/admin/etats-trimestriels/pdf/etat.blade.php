...
.tri-title { font-size:13px; font-weight:bold; color:#1a2e3b; }
...
.dt th { background:#1B4F6B; color:#fff; padding:7px 10px; text-align:left; font-size:8px; text-transform:uppercase; letter-spacing:.5px; }
