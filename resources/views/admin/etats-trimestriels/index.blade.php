...
<div class="space-y-4 md:space-y-5">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        @endphp
        <div class="bg-white rounded-[14px] border border-bimo-navy/10 overflow-hidden flex flex-col" style="border-top: 3px solid {{ match($statut) { 'telecharge'=>'var(--ac)', 'en_cours'=>'#1B4F6B', 'a_deposer','en_retard'=>'#C81224', default=>'rgba(27,79,107,.1)' } }}">
