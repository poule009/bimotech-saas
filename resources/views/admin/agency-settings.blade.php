                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            {{-- Supprimer le logo --}}
                            @if($agency->logo_path)
                            <form method="POST" action="{{ route('admin.agency.logo.delete') }}" style="display:inline-block;margin-top:8px"
                        ...
                        <div class="form-group">
                            ...
                            <div style="display:flex;align-items:center;gap:10px;margin-bottom:10px">
                                <input type="color" id="color-native" value="{{ old('couleur_primaire', $agency->couleur_primaire ?? '#c9a84c') }}"
                            ...
                            <div class="color-swatches">
                                @foreach(['#c9a84c','#1d4ed8','#16a34a','#dc2626','#7c3aed','#0d1117','#0891b2','#d97706','#1a3c5e','#be185d'] as $color)
                    ...
                    <div style="padding:14px">
                        <div class="mini-sidebar">
                            ...
                            <div class="mini-sidebar-top">
                                <div class="mini-logo-box" id="preview-logo-box" style="background:{{ $agency->couleur_primaire ?? '#c9a84c' }}">
                                    @if($agency->logo_path)
                                        <img src="{{ Storage::url($agency->logo_path) }}" class="mini-logo-img" id="preview-logo-img" alt="">
                                    @else
                            ...
                            <div class="mini-nav">
                                ...
                                <div class="mini-nav-item">
                                    ...
                                    <div class="mini-nav-line {{ $i % 2 === 0 ? 'short':'' }}"></div>
                                </div>
                                @endforeach
                            </div>
                        </div>
                    ...
                    <div style="padding:0 14px 14px">
                        <div style="background:rgba(255,255,255,.04);border-radius:8px;padding:10px 14px">
                            <div class="info-row">
                                ...
                                <div class="info-val" id="info-name">{{ $agency->name }}</div>
                            </div>
                            <div class="info-row">
                                <div class="info-lbl">Email</div>
                                <div class="info-val" id="info-email">{{ $agency->email ?? '—' }}</div>
                            </div>
                            <div class="info-row">
                                <div class="info-lbl">Téléphone</div>
                                <div class="info-val {{ !$agency->telephone ? 'missing':'' }}" id="info-tel">
                                    {{ $agency->telephone ?? 'Non renseigné' }}
                                </div>
                            </div>
                            <div class="info-row">
                                <div class="info-lbl">NINEA</div>
                                <div class="info-val {{ !$agency->ninea ? 'missing':'' }}" id="info-ninea">
                            ...
                            <div class="info-row">
                                ...
                                <div style="display:flex;align-items:center;gap:6px">
                                    <div id="info-color-dot" style="width:12px;height:12px;border-radius:3px;background:{{ $agency->couleur_primaire ?? '#c9a84c' }}"></div>
                                    <div class="info-val" id="info-color">{{ $agency->couleur_primaire ?? '#c9a84c' }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="checklist">
                            ...
                            <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:10px">
                                <span style="font-size:12px;font-weight:600;color:#0d1117">{{ $nbDone }} / {{ count($checks) }} complété(s)</span>
                                <div style="display:flex;align-items:center;gap:4px">
                                    @for($i = 0; $i < count($checks); $i++)
                                    <div style="height:4px;width:{{ floor(120/count($checks)) }}px;border-radius:99px;background:{{ $i < $nbDone ? '#16a34a':'#e5e7eb' }}"></div>
                                    @endfor
                                </div>
                            </div>
