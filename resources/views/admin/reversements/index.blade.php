...
<div class="space-y-4 md:space-y-6">
    ...
    <div class="flex items-start justify-between gap-4">
        <div>
            <h1 class="font-display font-extrabold text-xl md:text-2xl text-bimo-text tracking-tight leading-tight">Reversements propriétaires</h1>
            <p class="font-body text-sm text-bimo-text/50 mt-1">Suivi des nets reversés et soldes mandants</p>
        </div>
    ...
    <div class="bg-white rounded-[14px] border border-bimo-navy/10 overflow-hidden">
        <div class="px-5 py-4 border-b border-bimo-navy/[5%] bg-bimo-bg2">
            <span class="font-display font-bold text-sm text-bimo-text">Soldes en attente</span>
        </div>
    ...
    <div class="bg-white rounded-[14px] border border-bimo-navy/10 overflow-hidden">
        <div class="px-5 py-4 border-b border-bimo-navy/[5%] bg-bimo-bg2">
            <span class="font-display font-bold text-sm text-bimo-text">Historique des reversements</span>
        </div>
        ...
        <div class="md:hidden divide-y divide-bimo-navy/[5%]">
            ...
            <div class="px-5 py-4">
                ...
                <div class="flex items-center gap-3 flex-wrap">
                    ...
                    <span class="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-body font-medium bg-bimo-navy/10 border border-bimo-navy/15 text-bimo-text/60">{{ $rev->mode_paiement_libelle }}</span>
                    @if($rev->reference)<span class="font-body text-[10px] text-bimo-text/30">{{ $rev->reference }}</span>@endif
                </div>
            </div>
            @empty
            <div class="px-5 py-10 text-center font-body text-sm text-bimo-text/30">Aucun reversement enregistré.</div>
            @endforelse
        </div>
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-bimo-navy/[5%]">
                    ...
                    <tr class="hover:bg-bimo-bg transition-colors duration-100">
                        <td class="px-5 py-3.5 font-body text-xs text-bimo-text/50">{{ $rev->date_reversement->format('d/m/Y') }}</td>
