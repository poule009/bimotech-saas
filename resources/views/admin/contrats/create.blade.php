                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="bien_id" id="bien_id" class="form-select {{ $errors->has('bien_id') ? 'error' : '' }}"
                            ...
                            <div style="display:flex;gap:8px;align-items:flex-start">
                                <select name="locataire_id" id="locataire_id"
                                    ...
                                    @foreach($locataires as $loc)
                                        <option value="{{ $loc->id }}"
                                            {{ old('locataire_id') == $loc->id ? 'selected' : '' }}>
                                            {{ $loc->name }}@if($loc->telephone) — {{ $loc->telephone }}@endif
                                        </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <div class="bail-grid">
                                ...
                                <div class="bail-pill">
                                    <input type="radio" name="type_bail" id="bail_{{ $key }}"
                                        value="{{ $key }}"
                                        {{ old('type_bail', 'habitation') === $key ? 'checked' : '' }}>
                                    <label for="bail_{{ $key }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="reference_bail" id="reference_bail"
                                ...
                                placeholder="Ex: BAIL-DKR-2024 — Sinon : BIMO-{{ now()->year }}-{ID}">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="nombre_mois_caution" id="nombre_mois_caution"
                                    class="form-input"
                                    value="{{ old('nombre_mois_caution', 1) }}"
                                    min="1" max="6">
                            </div>
                        </div>
                    </div>
...
@include('admin.contrats._section-fiscal', ['contrat' => null])
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="text" name="garant_nom" id="garant_nom"
                                    class="form-input" value="{{ old('garant_nom') }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="garant_telephone" id="garant_telephone"
                                    class="form-input" value="{{ old('garant_telephone') }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="garant_adresse" id="garant_adresse"
                                class="form-input" value="{{ old('garant_adresse') }}"
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="observations" id="observations"
                                class="form-textarea"
                                placeholder="Clauses particulières, état des lieux, remarques…">{{ old('observations') }}</textarea>
                        </div>
                    </div>
...
async function creerLocataire() {
    ...
    try {
        const r = await fetch('{{ route("admin.contrats.locataire-rapide") }}', {
            method: 'POST',
            headers: {
