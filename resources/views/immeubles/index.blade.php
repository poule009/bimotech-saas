...
<div class="space-y-4 md:space-y-6">
    ...
    <div class="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        <div>
            <h1 class="font-display font-extrabold text-xl md:text-2xl text-bimo-text tracking-tight leading-tight">Immeubles</h1>
            <p class="font-body text-sm text-bimo-text/50 mt-1">{{ $immeubles->total() }} immeuble(s) enregistré(s)</p>
        </div>
        @can('isStaff')
            ...
            <div class="p-5 flex flex-col flex-1">
                ...
                <div class="flex items-start gap-3 mb-4">
                    <div class="w-10 h-10 rounded-[10px] bg-bimo-navy/5 flex items-center justify-center flex-shrink-0">
                        <svg class="w-5 h-5 text-bimo-text/40" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
                            <rect x="2" y="3" width="20" height="18" rx="2"/>
                            <line x1="2" y1="9" x2="22" y2="9"/><line x1="12" y1="3" x2="12" y2="21"/>
                        </svg>
                    </div>
                    <div class="min-w-0 flex-1">
                        <h3 class="font-display font-bold text-sm text-bimo-text truncate leading-tight">{{ $immeuble->nom }}</h3>
                        <p class="font-body text-xs text-bimo-text/50 mt-0.5">{{ $immeuble->adresse }}, {{ $immeuble->ville }}</p>
                    </div>
                </div>

                {{-- Badges --}}
                <div class="flex flex-wrap gap-2 mb-4">
                    <span class="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full border border-bimo-navy/15 bg-bimo-navy/5 text-[11px] font-body font-medium text-bimo-text/70">
                    ...
                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full border border-bimo-navy/10 bg-bimo-navy/[4%] text-[11px] font-body font-medium text-bimo-text/60">
