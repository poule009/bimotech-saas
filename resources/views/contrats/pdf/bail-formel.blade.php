...
{{-- Pied de page fixe --}}
<div class="footer">
    <div class="footer-l">{{ $agency->name ?? 'bee' }} · Contrat de bail · Réf. {{ $contrat->reference_bail_affichee }}</div>
...
<div class="header">
    <div class="header-inner">
        <div class="header-left">
            ...
            @else
                <div class="agence-nom">{{ $agency->name ?? 'bee' }}</div>
            @endif
...
<div class="body">
    ...
    <div class="mentions">
        ...
        Document établi par <strong>{{ $agency->name ?? 'bee' }}</strong> en qualité de Mandataire.
