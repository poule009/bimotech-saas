...
<title>Demander une démo — bee</title>
...
<div class="pt-[120px] pb-16 px-[5%] text-center">
    ...
    <h1 class="font-display font-extrabold text-[clamp(28px,5vw,50px)] tracking-tight leading-tight mb-4">
        Voyez bee en action<br>pour votre <em class="not-italic text-marketing-gold">agence</em>
    </h1>
...
<div class="max-w-[920px] mx-auto px-[5%] pb-24 grid grid-cols-1 md:grid-cols-[1.1fr_1fr] gap-12 items-start">
    ...
    <div>
        ...
        <div class="bg-[#161b22] border border-[rgba(255,255,255,.1)] rounded-[14px] p-6">
            <p class="font-body font-light text-sm text-[#8b949e] leading-[1.8] italic mb-4">"Avant bee, je gérais tout sur Excel. Maintenant mes quittances sont générées automatiquement et mes propriétaires voient leurs revenus en temps réel. La démo m'a convaincu en 20 minutes."</p>
    ...
    <div class="bg-[#161b22] border border-[rgba(255,255,255,.08)] rounded-[16px] p-10 md:sticky md:top-[84px]">
        ...
        <a href="https://wa.me/221XXXXXXXXX?text=Bonjour bee, je souhaite réserver une démo pour mon agence." target="_blank"
...
<footer class="px-[5%] py-8 border-t border-[rgba(255,255,255,.08)] flex flex-col md:flex-row items-center justify-between gap-4 flex-wrap">
    <div class="font-display font-extrabold text-[15px] text-marketing-gold">bee</div>
    ...
    <div class="font-body text-xs text-[#484f58]">© {{ date('Y') }} bee · Dakar, Sénégal</div>
</footer>
