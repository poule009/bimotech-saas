    ...
    <div class="form-card">
        ...
        <form method="POST" action="{{ route('demo.send') }}">
            ...
            <div class="field">
                ...
                @error('telephone')<div class="input-error">{{ $message }}</div>@enderror
            </div>
            ...
            <div class="row-2">
                <div class="field">
                    ...
                    <select name="nb_biens">
                        ...
                        <option value="1-10"   {{ old('nb_biens') === '1-10'   ? 'selected' : '' }}>1 à 10 biens</option>
                        <option value="10-30"  {{ old('nb_biens') === '10-30'  ? 'selected' : '' }}>10 à 30 biens</option>
                        <option value="30-100" {{ old('nb_biens') === '30-100' ? 'selected' : '' }}>30 à 100 biens</option>
                        <option value="100+"   {{ old('nb_biens') === '100+'   ? 'selected' : '' }}>Plus de 100</option>
                    </select>
                </div>
                <div class="field">
                    <label>Ville</label>
                    <select name="ville">
                        ...
                        <option value="dakar"     {{ old('ville') === 'dakar'     ? 'selected' : '' }}>Dakar</option>
                        <option value="thies"     {{ old('ville') === 'thies'     ? 'selected' : '' }}>Thiès</option>
