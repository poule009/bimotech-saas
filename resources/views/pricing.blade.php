...
<div class="max-w-[1100px] mx-auto px-[5%] pt-20 pb-24">
    ...
    <div class="text-center mb-12">
        ...
        <h1 class="font-display font-extrabold text-[clamp(30px,5vw,52px)] tracking-tight leading-tight text-bimo-text mb-4">Le bon plan pour<br>votre <em class="not-italic text-bimo-gold">agence</em></h1>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-5 items-start mb-14">
        ...
        <div class="bg-bimo-navy border border-bimo-navy rounded-[14px] p-7 pt-11 relative shadow-xl">
            ...
            <a href="{{ route('agency.register') }}" class="block w-full py-3 rounded-[10px] font-display font-bold text-sm text-center text-bimo-text no-underline bg-bimo-gold hover:opacity-90 transition-opacity duration-150 mb-1.5 shadow-lg">Essai gratuit 30 jours</a>
    ...
    <div class="mb-14">
        ...
        <div class="max-w-[680px] mx-auto">
            ...
            <div class="faq-item border-b border-bimo-navy/10 first:border-t first:border-bimo-navy/10">
                <div class="flex items-center justify-between py-4 cursor-pointer font-body font-semibold text-sm text-bimo-text gap-3 hover:text-bimo-gold transition-colors duration-150" onclick="toggleFaq(this)">
                    {{ $q }}
