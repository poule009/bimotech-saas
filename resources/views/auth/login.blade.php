...
<main class="right">
    <div class="form-box">
        ...
        <a href="{{ route('auth.google') }}"
           style="display:flex;align-items:center;justify-content:center;gap:10px;width:100%;padding:12px 16px;border:1px solid rgba(255,255,255,.1);border-radius:10px;font-size:14px;font-weight:600;color:#e6edf3;background:#161b22;text-decoration:none;transition:background .15s,border-color .15s;margin-bottom:1.25rem;"
           onmouseover="this.style.background='#1c2128';this.style.borderColor='rgba(255,255,255,.2)'"
           onmouseout="this.style.background='#161b22';this.style.borderColor='rgba(255,255,255,.1)'">
