...
<title>Réinitialiser le mot de passe — bee</title>
...
function checkStrength(val) {
    ...
    var levels = [{w:'25%',bg:'#A60F1C',txt:'Trop court'},{w:'50%',bg:'#A60F1C',txt:'Faible'},{w:'75%',bg:'#C9A84C',txt:'Moyen'},{w:'100%',bg:'#4B5563',txt:'Fort'}];
