<x-app-layout>
    <x-slot name="header">Nouveau bien</x-slot>
...
<div style="padding:24px 32px 48px">
    ...
    <form method="POST" action="{{ route('biens.store') }}" id="form-bien">
        @csrf
        <div class="form-grid">
            <div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="adresse" id="adresse" class="form-input {{ $errors->has('adresse') ? 'error':'' }}"
                                value="{{ old('adresse') }}" placeholder="N° rue, nom de la rue">
                            @error('adresse')<div class="form-error">{{ $message }}</div>@enderror
                        </div>
                        <div class="form-row">
                            <div class="form-group">
                                <label class="form-label" for="ville">Ville <span class="req">*</span></label>
                                <input type="text" name="ville" id="ville" class="form-input {{ $errors->has('ville') ? 'error':'' }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="quartier" id="quartier" class="form-input"
                                    value="{{ old('quartier') }}" placeholder="Ex: Plateau">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="number" name="surface_m2" id="surface_m2" class="form-input"
                                    value="{{ old('surface_m2') }}" placeholder="Ex: 80" min="1">
                            </div>
                            <div class="form-group">
                                ...
                                <input type="number" name="nombre_pieces" id="nombre_pieces" class="form-input"
                                    value="{{ old('nombre_pieces') }}" placeholder="Ex: 3" min="1">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="toggle-row" for="meuble">
                                <input type="checkbox" name="meuble" id="meuble" value="1" {{ old('meuble') ? 'checked':'' }}>
                                <div>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="number" name="loyer_mensuel" id="loyer_mensuel"
                                    ...
                                    value="{{ old('loyer_mensuel') }}" placeholder="Ex: 200000" min="1" step="500"
                                    oninput="calcRecap()">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="taux_commission" id="taux_commission"
                                    ...
                                    value="{{ old('taux_commission', 10) }}" placeholder="10" min="1" max="20" step="0.5"
                                    oninput="calcRecap()">
                ...
                <div class="card">
                    ...
                    <div class="submit-bar">
                        <a href="{{ route('biens.index') }}" class="btn-cancel">Annuler</a>
