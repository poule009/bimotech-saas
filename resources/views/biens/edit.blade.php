        ...
        <div class="space-y-5">
            ...
            <div class="f-card">
                ...
                <div class="flex flex-wrap gap-5">
                    <label class="flex items-center gap-2 text-[14px] cursor-pointer"><input type="checkbox" name="meuble" value="1" @checked(old('meuble', $bien->meuble)) class="w-[16px] h-[16px] accent-teal"> Meublé</label>
