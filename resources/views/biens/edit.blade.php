                ...
                <form method="POST" action="{{ route('biens.update', $bien) }}">
                            ...
                            <select name="proprietaire_id" class="input">
                                @foreach($proprietaires as $proprio)
                                    <option value="{{ $proprio->id }}"
                                            {{ old('proprietaire_id', $bien->proprietaire_id) == $proprio->id ? 'selected' : '' }}>
                        ...
                        <div>
                            ...
                            <select name="type" class="input">
                                ...
                                @foreach(['Appartement', 'Villa', 'Studio', 'Chambre', 'Bureau', 'Local commercial', 'Entrepôt', 'Terrain', 'Maison', 'Duplex'] as $type)
                                    <option value="{{ $type }}" {{ old('type', $bien->type) === $type ? 'selected' : '' }}>{{ $type }}</option>
                                @endforeach
                            </select>
                            @error('type')
                                <div style="font-size:12px;color:#dc2626;margin-top:4px;">{{ $message }}</div>
                    ...
                    <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:16px;margin-bottom:20px;">
                        <div>
                            ...
                            <input type="number" name="surface_m2" value="{{ old('surface_m2', $bien->surface_m2) }}"
                        ...
                        <div>
                            ...
                            <input type="number" name="nombre_pieces" value="{{ old('nombre_pieces', $bien->nombre_pieces) }}"
                    ...
                    <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;margin-bottom:20px;">
                        ...
                        <div>
                            ...
                            <input type="number" name="taux_commission" value="{{ old('taux_commission', $bien->taux_commission) }}"
