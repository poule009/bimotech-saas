...
<title>Mentions légales — Renlio</title>
...
<nav class="fixed top-0 left-0 right-0 z-[100] px-[5%] h-16 flex items-center justify-between bg-[rgba(13,17,23,.85)] backdrop-blur-md border-b border-[rgba(255,255,255,.08)]">
    <a href="{{ url('/') }}" class="no-underline flex items-center" aria-label="Renlio — Accueil">
        <img src="/images/logo.jpeg" alt="Renlio" class="h-[34px] w-auto">
    </a>
...
<div class="max-w-[720px] mx-auto px-[5%] pt-[120px] pb-24">
    ...
    <p class="font-body text-sm text-[#8b949e] leading-[1.8] mb-3">L'ensemble du contenu de la plateforme Renlio — textes, graphismes, logotypes, icônes, images, code source — est la propriété exclusive de Renlio ou de ses partenaires et est protégé par les lois sénégalaises et internationales relatives à la propriété intellectuelle.</p>
    <p class="font-body text-sm text-[#8b949e] leading-[1.8] mb-3">Toute reproduction, représentation, modification, publication ou adaptation de tout ou partie des éléments du site, quel que soit le moyen ou le procédé utilisé, est interdite sans autorisation écrite préalable de Renlio.</p>
    ...
    <p class="font-body text-sm text-[#8b949e] leading-[1.8] mb-3">Les données personnelles collectées via la plateforme (nom, email, informations d'agence) sont utilisées exclusivement dans le cadre de la fourniture du service Renlio.</p>
    ...
    <p class="font-body text-sm text-[#8b949e] leading-[1.8] mb-3">La plateforme Renlio utilise des cookies strictement nécessaires au fonctionnement du service (session, sécurité CSRF). Aucun cookie publicitaire ou de tracking tiers n'est utilisé.</p>
    ...
    <p class="font-body text-sm text-[#8b949e] leading-[1.8] mb-3">Renlio s'efforce d'assurer l'exactitude et la mise à jour des informations diffusées. Toutefois, Renlio ne peut garantir l'exactitude, la précision ou l'exhaustivité des informations mises à disposition.</p>
    <p class="font-body text-sm text-[#8b949e] leading-[1.8] mb-3">Renlio ne pourra être tenu responsable des dommages directs ou indirects résultant de l'utilisation de la plateforme ou de l'impossibilité d'y accéder.</p>
    ...
    <p class="font-body text-sm text-[#8b949e] leading-[1.8] mb-3">Les présentes mentions légales sont soumises au droit sénégalais. Tout litige relatif à l'utilisation de la plateforme Renlio relève de la compétence exclusive des tribunaux de Dakar, Sénégal.</p>
