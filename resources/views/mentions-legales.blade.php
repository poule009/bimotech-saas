...
<div class="max-w-[720px] mx-auto px-[5%] pt-[120px] pb-24">
    ...
    <p class="font-body text-sm text-bimo-text/60 leading-[1.8] mb-3">L'ensemble du contenu de la plateforme BimoTech Immo — textes, graphismes, logotypes, icônes, images, code source — est la propriété exclusive de BimoTech ou de ses partenaires et est protégé par les lois sénégalaises et internationales relatives à la propriété intellectuelle.</p>
    <p class="font-body text-sm text-bimo-text/60 leading-[1.8] mb-3">Toute reproduction, représentation, modification, publication ou adaptation de tout ou partie des éléments du site, quel que soit le moyen ou le procédé utilisé, est interdite sans autorisation écrite préalable de BimoTech.</p>
    ...
    <p class="font-body text-sm text-bimo-text/60 leading-[1.8] mb-3">BimoTech s'efforce d'assurer l'exactitude et la mise à jour des informations diffusées. Toutefois, BimoTech ne peut garantir l'exactitude, la précision ou l'exhaustivité des informations mises à disposition.</p>
    <p class="font-body text-sm text-bimo-text/60 leading-[1.8] mb-3">BimoTech ne pourra être tenu responsable des dommages directs ou indirects résultant de l'utilisation de la plateforme ou de l'impossibilité d'y accéder.</p>
