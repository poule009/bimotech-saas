...
<div class="pt-[120px] pb-16 px-[5%] text-center bg-bimo-bg">
    ...
    <p class="font-body font-light text-base text-bimo-text/50 max-w-[440px] mx-auto leading-relaxed">Tout ce que vous voulez savoir avant de démarrer avec bee.</p>
</div>
...
<div class="max-w-[780px] mx-auto px-[5%] pb-24">
    ...
    $faqs = [
        ...
        'Conformité fiscale' => [
            ['q' => 'bee est-il vraiment conforme à la TVA sénégalaise à 18% ?', 'a' => 'Oui. Le calcul de TVA à 18% sur les commissions d\'agence est intégré nativement, conformément au CGI article 357. Chaque quittance affiche la décomposition HT / TVA / TTC automatiquement. Aucune configuration nécessaire.'],
            ['q' => 'Qu\'est-ce que la loi 81-18 et comment bee la gère ?', 'a' => 'La loi 81-18 encadre les loyers au Sénégal en fixant des plafonds selon la surface du bien. bee vérifie automatiquement si le loyer saisi respecte ces plafonds et affiche une alerte si ce n\'est pas le cas.'],
            ['q' => 'Les quittances générées sont-elles légalement valides ?', 'a' => 'Oui. Les quittances PDF générées par bee incluent le NINEA de votre agence, le détail TVA, les références du contrat et sont numérotées séquentiellement. Elles sont conformes aux exigences de la Direction des Impôts du Sénégal.'],
        ],
        'Fonctionnement' => [
            ['q' => 'Mes données sont-elles sécurisées et séparées des autres agences ?', 'a' => 'Absolument. bee utilise une architecture multi-tenant : les données de chaque agence sont strictement isolées. Un utilisateur d\'une agence ne peut jamais voir les données d\'une autre. Toutes les connexions sont chiffrées (HTTPS).'],
